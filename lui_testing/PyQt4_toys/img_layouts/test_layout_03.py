...
class ImgTab(QtGui.QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self.btn_go1 = QtGui.QPushButton('\n      Go   \n', self)
        self.btn_go1.clicked.connect(self.B_go_clicked1)
        main_box.addWidget(self.btn_go1)

        self.btn_go2 = QtGui.QPushButton('\n      Go   \n', self)
        self.btn_go2.clicked.connect(self.B_go_clicked2)
        main_box.addWidget(self.btn_go2)
    ...
    def B_go_clicked1(self):

        print "B_go_clicked(self)"
        self.scrollArea.update_me(self.lst_tmp3)



    def B_go_clicked2(self):

        print "B_go_clicked(self)"
        self.scrollArea.update_me(self.lst_tmp4)
