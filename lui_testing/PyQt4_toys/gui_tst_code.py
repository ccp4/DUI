...
class inner_widg( QWidget):
    ...
    def __init__(self, parent):
        ...
        hbox_min_cell_volume =  QHBoxLayout()
        label_min_cell_volume = QLabel("        min_cell_volume")
        label_min_cell_volume.setFont(QFont("Times",16, QFont.Bold))
        hbox_min_cell_volume.addWidget(label_min_cell_volume)
        spn_box_min_cell_volume = QDoubleSpinBox()
        hbox_min_cell_volume.addWidget(spn_box_min_cell_volume)
        bg_box.addLayout(hbox_min_cell_volume)
        ...
        hbox_max_cell_step_size =  QHBoxLayout()
        label_max_cell_step_size = QLabel("        max_cell_step_size")
        label_max_cell_step_size.setFont(QFont("Times",16, QFont.Bold))
        hbox_max_cell_step_size.addWidget(label_max_cell_step_size)
        spn_box_max_cell_step_size = QDoubleSpinBox()
        hbox_max_cell_step_size.addWidget(spn_box_max_cell_step_size)
        bg_box.addLayout(hbox_max_cell_step_size)
        ...
        hbox_sys_absent_threshold =  QHBoxLayout()
        label_sys_absent_threshold = QLabel("                sys_absent_threshold")
        label_sys_absent_threshold.setFont(QFont("Times",15, QFont.Bold))
        hbox_sys_absent_threshold.addWidget(label_sys_absent_threshold)
        spn_box_sys_absent_threshold = QDoubleSpinBox()
        hbox_sys_absent_threshold.addWidget(spn_box_sys_absent_threshold)
        bg_box.addLayout(hbox_sys_absent_threshold)
        ...
        label_tst = QLabel("    stills")
        label_tst.setFont(QFont("Monospace", 13, QFont.Bold))
        bg_box.addWidget(label_tst)
        hbox_ewald_proximity_resolution_cutoff =  QHBoxLayout()
        label_ewald_proximity_resolution_cutoff = QLabel("                ewald_proximity_resolution_cutoff")
        label_ewald_proximity_resolution_cutoff.setFont(QFont("Times",15, QFont.Bold))
        hbox_ewald_proximity_resolution_cutoff.addWidget(label_ewald_proximity_resolution_cutoff)
        spn_box_ewald_proximity_resolution_cutoff = QDoubleSpinBox()
        hbox_ewald_proximity_resolution_cutoff.addWidget(spn_box_ewald_proximity_resolution_cutoff)
        bg_box.addLayout(hbox_ewald_proximity_resolution_cutoff)
        ...
        label_fix_list.setFont(QFont("Times",14, QFont.Bold))
        hbox_fix_list.addWidget(label_fix_list)
        label_tst = QLabel("                restraints")
        label_tst.setFont(QFont("Monospace", 13, QFont.Bold))
        bg_box.addWidget(label_tst)
        label_tst = QLabel("                    tie_to_target")
        label_tst.setFont(QFont("Monospace", 13, QFont.Bold))
        bg_box.addWidget(label_tst)
        hbox_values =  QHBoxLayout()
        label_values = QLabel("                                                values")
        label_values.setFont(QFont("Times",14, QFont.Bold))
        hbox_values.addWidget(label_values)
        hbox_sigmas =  QHBoxLayout()
        label_sigmas = QLabel("                                                sigmas")
        label_sigmas.setFont(QFont("Times",14, QFont.Bold))
        hbox_sigmas.addWidget(label_sigmas)
        hbox_id =  QHBoxLayout()
        label_id = QLabel("                                                id")
        label_id.setFont(QFont("Times",14, QFont.Bold))
        hbox_id.addWidget(label_id)
        label_tst = QLabel("                    tie_to_group")
        label_tst.setFont(QFont("Monospace", 13, QFont.Bold))
        bg_box.addWidget(label_tst)
        hbox_target =  QHBoxLayout()
        label_target = QLabel("                                                target")
        label_target.setFont(QFont("Times",14, QFont.Bold))
        hbox_target.addWidget(label_target)
        spn_box_target = QComboBox()
        spn_box_target.addItem("*mean")
        spn_box_target.addItem("median")
        hbox_target.addWidget(spn_box_target)
        bg_box.addLayout(hbox_target)
        hbox_sigmas =  QHBoxLayout()
        label_sigmas = QLabel("                                                sigmas")
        label_sigmas.setFont(QFont("Times",14, QFont.Bold))
        hbox_sigmas.addWidget(label_sigmas)
        ...
        spn_box_engine.addItem("SparseLevMar")
        ...
        hbox_log =  QHBoxLayout()
        label_log = QLabel("        log")
        label_log.setFont(QFont("Times",16, QFont.Bold))
        hbox_log.addWidget(label_log)
        spn_box_log = QLineEdit()
        hbox_log.addWidget(spn_box_log)
        bg_box.addLayout(hbox_log)
        hbox_debug_log =  QHBoxLayout()
        label_debug_log = QLabel("        debug_log")
        label_debug_log.setFont(QFont("Times",16, QFont.Bold))
        hbox_debug_log.addWidget(label_debug_log)
        spn_box_debug_log = QLineEdit()
        hbox_debug_log.addWidget(spn_box_debug_log)
        bg_box.addLayout(hbox_debug_log)
        hbox_verbosity =  QHBoxLayout()
        label_verbosity = QLabel("verbosity")
