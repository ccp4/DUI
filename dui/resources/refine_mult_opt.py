...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        label_84 = QLabel("            tukey")
        label_84.setPalette(palette_scope)
        label_84.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_84)

        hbox_lay_iqr_multiplier_85 =  QHBoxLayout()
        label_iqr_multiplier_85 = QLabel("                iqr_multiplier")
        label_iqr_multiplier_85.setPalette(palette_object)
        label_iqr_multiplier_85.setFont(QFont("Monospace", 10))
        hbox_lay_iqr_multiplier_85.addWidget(label_iqr_multiplier_85)

        box_iqr_multiplier_85 = QDoubleSpinBox()
        box_iqr_multiplier_85.setValue(1.5)
        box_iqr_multiplier_85.local_path = "refinement.reflections.outlier.tukey.iqr_multiplier"
        box_iqr_multiplier_85.valueChanged.connect(self.spnbox_changed)
        hbox_lay_iqr_multiplier_85.addWidget(box_iqr_multiplier_85)
        bg_box.addLayout(hbox_lay_iqr_multiplier_85)
        ...
        hbox_lay_alpha_87 =  QHBoxLayout()
        label_alpha_87 = QLabel("                alpha")
        label_alpha_87.setPalette(palette_object)
        label_alpha_87.setFont(QFont("Monospace", 10))
        hbox_lay_alpha_87.addWidget(label_alpha_87)

        box_alpha_87 = QDoubleSpinBox()
        box_alpha_87.setValue(0.5)
        box_alpha_87.local_path = "refinement.reflections.outlier.mcd.alpha"
        box_alpha_87.valueChanged.connect(self.spnbox_changed)
        hbox_lay_alpha_87.addWidget(box_alpha_87)
        bg_box.addLayout(hbox_lay_alpha_87)

        hbox_lay_max_n_groups_88 =  QHBoxLayout()
        label_max_n_groups_88 = QLabel("                max_n_groups")
        label_max_n_groups_88.setPalette(palette_object)
        label_max_n_groups_88.setFont(QFont("Monospace", 10))
        hbox_lay_max_n_groups_88.addWidget(label_max_n_groups_88)

        box_max_n_groups_88 = QSpinBox()
        box_max_n_groups_88.setValue(5)
        box_max_n_groups_88.local_path = "refinement.reflections.outlier.mcd.max_n_groups"
        box_max_n_groups_88.valueChanged.connect(self.spnbox_changed)
        hbox_lay_max_n_groups_88.addWidget(box_max_n_groups_88)
        bg_box.addLayout(hbox_lay_max_n_groups_88)

        hbox_lay_min_group_size_89 =  QHBoxLayout()
        label_min_group_size_89 = QLabel("                min_group_size")
        label_min_group_size_89.setPalette(palette_object)
        label_min_group_size_89.setFont(QFont("Monospace", 10))
        hbox_lay_min_group_size_89.addWidget(label_min_group_size_89)

        box_min_group_size_89 = QSpinBox()
        box_min_group_size_89.setValue(300)
        box_min_group_size_89.local_path = "refinement.reflections.outlier.mcd.min_group_size"
        box_min_group_size_89.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_group_size_89.addWidget(box_min_group_size_89)
        bg_box.addLayout(hbox_lay_min_group_size_89)

        hbox_lay_n_trials_90 =  QHBoxLayout()
        label_n_trials_90 = QLabel("                n_trials")
        label_n_trials_90.setPalette(palette_object)
        label_n_trials_90.setFont(QFont("Monospace", 10))
        hbox_lay_n_trials_90.addWidget(label_n_trials_90)

        box_n_trials_90 = QSpinBox()
        box_n_trials_90.setValue(500)
        box_n_trials_90.local_path = "refinement.reflections.outlier.mcd.n_trials"
        box_n_trials_90.valueChanged.connect(self.spnbox_changed)
        hbox_lay_n_trials_90.addWidget(box_n_trials_90)
        bg_box.addLayout(hbox_lay_n_trials_90)

        hbox_lay_k1_91 =  QHBoxLayout()
        label_k1_91 = QLabel("                k1")
        label_k1_91.setPalette(palette_object)
        label_k1_91.setFont(QFont("Monospace", 10))
        hbox_lay_k1_91.addWidget(label_k1_91)

        box_k1_91 = QSpinBox()
        box_k1_91.setValue(2)
        box_k1_91.local_path = "refinement.reflections.outlier.mcd.k1"
        box_k1_91.valueChanged.connect(self.spnbox_changed)
        hbox_lay_k1_91.addWidget(box_k1_91)
        bg_box.addLayout(hbox_lay_k1_91)

        hbox_lay_k2_92 =  QHBoxLayout()
        label_k2_92 = QLabel("                k2")
        label_k2_92.setPalette(palette_object)
        label_k2_92.setFont(QFont("Monospace", 10))
        hbox_lay_k2_92.addWidget(label_k2_92)

        box_k2_92 = QSpinBox()
        box_k2_92.setValue(2)
        box_k2_92.local_path = "refinement.reflections.outlier.mcd.k2"
        box_k2_92.valueChanged.connect(self.spnbox_changed)
        hbox_lay_k2_92.addWidget(box_k2_92)
        bg_box.addLayout(hbox_lay_k2_92)

        hbox_lay_k3_93 =  QHBoxLayout()
        label_k3_93 = QLabel("                k3")
        label_k3_93.setPalette(palette_object)
        label_k3_93.setFont(QFont("Monospace", 10))
        hbox_lay_k3_93.addWidget(label_k3_93)

        box_k3_93 = QSpinBox()
        box_k3_93.setValue(100)
        box_k3_93.local_path = "refinement.reflections.outlier.mcd.k3"
        box_k3_93.valueChanged.connect(self.spnbox_changed)
        hbox_lay_k3_93.addWidget(box_k3_93)
        bg_box.addLayout(hbox_lay_k3_93)

        hbox_lay_threshold_probability_94 =  QHBoxLayout()
        label_threshold_probability_94 = QLabel("                threshold_probability")
        label_threshold_probability_94.setPalette(palette_object)
        label_threshold_probability_94.setFont(QFont("Monospace", 10))
        hbox_lay_threshold_probability_94.addWidget(label_threshold_probability_94)

        box_threshold_probability_94 = QDoubleSpinBox()
        box_threshold_probability_94.setValue(0.975)
        box_threshold_probability_94.local_path = "refinement.reflections.outlier.mcd.threshold_probability"
        box_threshold_probability_94.valueChanged.connect(self.spnbox_changed)
        hbox_lay_threshold_probability_94.addWidget(box_threshold_probability_94)
        bg_box.addLayout(hbox_lay_threshold_probability_94)

        label_95 = QLabel("            sauter_poon")
        label_95.setPalette(palette_scope)
        label_95.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_95)

        hbox_lay_px_sz_96_0 =  QHBoxLayout()
        label_px_sz_96_0 = QLabel("                px_sz[1]")
        label_px_sz_96_0.setPalette(palette_object)
        label_px_sz_96_0.setFont(QFont("Monospace", 10))
        hbox_lay_px_sz_96_0.addWidget(label_px_sz_96_0)
        box_px_sz_96_0 = QDoubleSpinBox()
        box_px_sz_96_0.local_path = "refinement.reflections.outlier.sauter_poon.px_sz"
        #box_px_sz_96_0.valueChanged.connect(self.spnbox_changed)
        hbox_lay_px_sz_96_1 =  QHBoxLayout()
        label_px_sz_96_1 = QLabel("                px_sz[2]")
        label_px_sz_96_1.setPalette(palette_object)
        label_px_sz_96_1.setFont(QFont("Monospace", 10))
        hbox_lay_px_sz_96_1.addWidget(label_px_sz_96_1)
        box_px_sz_96_1 = QDoubleSpinBox()
        box_px_sz_96_1.local_path = "refinement.reflections.outlier.sauter_poon.px_sz"
        #box_px_sz_96_1.valueChanged.connect(self.spnbox_changed)
        hbox_lay_px_sz_96_0.addWidget(box_px_sz_96_0)
        bg_box.addLayout(hbox_lay_px_sz_96_0)
        hbox_lay_px_sz_96_1.addWidget(box_px_sz_96_1)
        bg_box.addLayout(hbox_lay_px_sz_96_1)

        hbox_lay_verbose_97 =  QHBoxLayout()
        label_verbose_97 = QLabel("                verbose")
        label_verbose_97.setPalette(palette_object)
        label_verbose_97.setFont(QFont("Monospace", 10))
        hbox_lay_verbose_97.addWidget(label_verbose_97)

        box_verbose_97 = QComboBox()
        box_verbose_97.local_path = "refinement.reflections.outlier.sauter_poon.verbose"
        box_verbose_97.tmp_lst=[]
        box_verbose_97.tmp_lst.append("True")
        box_verbose_97.tmp_lst.append("False")
        for lst_itm in box_verbose_97.tmp_lst:
            box_verbose_97.addItem(lst_itm)
        box_verbose_97.setCurrentIndex(1)
        box_verbose_97.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_verbose_97.addWidget(box_verbose_97)
        bg_box.addLayout(hbox_lay_verbose_97)

        hbox_lay_pdf_98 =  QHBoxLayout()
        label_pdf_98 = QLabel("                pdf")
        label_pdf_98.setPalette(palette_object)
        label_pdf_98.setFont(QFont("Monospace", 10))
        hbox_lay_pdf_98.addWidget(label_pdf_98)

        box_pdf_98 = QLineEdit()
        box_pdf_98.local_path = "refinement.reflections.outlier.sauter_poon.pdf"
        box_pdf_98.textChanged.connect(self.spnbox_changed)
        hbox_lay_pdf_98.addWidget(box_pdf_98)
        bg_box.addLayout(hbox_lay_pdf_98)
