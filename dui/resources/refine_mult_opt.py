...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        label_apply_to_all_34.setFont(QFont("Monospace"))
        ...
        label_target_36.setFont(QFont("Monospace"))
        ...
        label_sigmas_37_0.setFont(QFont("Monospace"))
        ...
        label_sigmas_37_1.setFont(QFont("Monospace"))
        ...
        label_sigmas_37_2.setFont(QFont("Monospace"))
        ...
        label_sigmas_37_3.setFont(QFont("Monospace"))
        ...
        label_sigmas_37_4.setFont(QFont("Monospace"))
        ...
        label_sigmas_37_5.setFont(QFont("Monospace"))
        ...
        label_apply_to_all_39.setFont(QFont("Monospace"))
        ...
        label_scan_varying_42.setFont(QFont("Monospace"))
        ...
        label_num_intervals_43.setFont(QFont("Monospace"))
        ...
        label_interval_width_degrees_44.setFont(QFont("Monospace"))
        ...
        label_absolute_num_intervals_45.setFont(QFont("Monospace"))
        ...
        label_UB_model_per_46.setFont(QFont("Monospace"))
        ...
        label_panels_48.setFont(QFont("Monospace"))
        ...
        label_hierarchy_level_49.setFont(QFont("Monospace"))
        ...
        label_fix_50.setFont(QFont("Monospace"))
        ...
        label_sparse_52.setFont(QFont("Monospace"))
        ...
        label_treat_single_image_as_still_53.setFont(QFont("Monospace"))
        ...
        label_54 = QLabel("    refinery")
        label_54.setPalette(palette_scope)
        label_54.setFont(QFont("Monospace"))
        bg_box.addWidget(label_54)
        hbox_lay_engine_55 =  QHBoxLayout()
        label_engine_55 = QLabel("        engine")
        label_engine_55.setPalette(palette_object)
        label_engine_55.setFont(QFont("Monospace"))
        hbox_lay_engine_55.addWidget(label_engine_55)

        box_engine_55 = QComboBox()
        box_engine_55.local_path = "refinement.refinery.engine"
        box_engine_55.tmp_lst=[]
        box_engine_55.tmp_lst.append("SimpleLBFGS")
        box_engine_55.tmp_lst.append("LBFGScurvs")
        box_engine_55.tmp_lst.append("GaussNewton")
        box_engine_55.tmp_lst.append("*LevMar")
        box_engine_55.tmp_lst.append("SparseLevMar")
        for lst_itm in box_engine_55.tmp_lst:
            box_engine_55.addItem(lst_itm)
        box_engine_55.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_engine_55.addWidget(box_engine_55)
        bg_box.addLayout(hbox_lay_engine_55)

        hbox_lay_track_step_56 =  QHBoxLayout()
        label_track_step_56 = QLabel("        track_step")
        label_track_step_56.setPalette(palette_object)
        label_track_step_56.setFont(QFont("Monospace"))
        hbox_lay_track_step_56.addWidget(label_track_step_56)

        box_track_step_56 = QComboBox()
        box_track_step_56.local_path = "refinement.refinery.track_step"
        box_track_step_56.tmp_lst=[]
        box_track_step_56.tmp_lst.append("True")
        box_track_step_56.tmp_lst.append("False")
        for lst_itm in box_track_step_56.tmp_lst:
            box_track_step_56.addItem(lst_itm)
        box_track_step_56.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_track_step_56.addWidget(box_track_step_56)
        bg_box.addLayout(hbox_lay_track_step_56)

        hbox_lay_track_gradient_57 =  QHBoxLayout()
        label_track_gradient_57 = QLabel("        track_gradient")
        label_track_gradient_57.setPalette(palette_object)
        label_track_gradient_57.setFont(QFont("Monospace"))
        hbox_lay_track_gradient_57.addWidget(label_track_gradient_57)

        box_track_gradient_57 = QComboBox()
        box_track_gradient_57.local_path = "refinement.refinery.track_gradient"
        box_track_gradient_57.tmp_lst=[]
        box_track_gradient_57.tmp_lst.append("True")
        box_track_gradient_57.tmp_lst.append("False")
        for lst_itm in box_track_gradient_57.tmp_lst:
            box_track_gradient_57.addItem(lst_itm)
        box_track_gradient_57.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_track_gradient_57.addWidget(box_track_gradient_57)
        bg_box.addLayout(hbox_lay_track_gradient_57)

        hbox_lay_track_parameter_correlation_58 =  QHBoxLayout()
        label_track_parameter_correlation_58 = QLabel("        track_parameter_correlation")
        label_track_parameter_correlation_58.setPalette(palette_object)
        label_track_parameter_correlation_58.setFont(QFont("Monospace"))
        hbox_lay_track_parameter_correlation_58.addWidget(label_track_parameter_correlation_58)

        box_track_parameter_correlation_58 = QComboBox()
        box_track_parameter_correlation_58.local_path = "refinement.refinery.track_parameter_correlation"
        box_track_parameter_correlation_58.tmp_lst=[]
        box_track_parameter_correlation_58.tmp_lst.append("True")
        box_track_parameter_correlation_58.tmp_lst.append("False")
        for lst_itm in box_track_parameter_correlation_58.tmp_lst:
            box_track_parameter_correlation_58.addItem(lst_itm)
        box_track_parameter_correlation_58.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_track_parameter_correlation_58.addWidget(box_track_parameter_correlation_58)
        bg_box.addLayout(hbox_lay_track_parameter_correlation_58)

        hbox_lay_track_out_of_sample_rmsd_59 =  QHBoxLayout()
        label_track_out_of_sample_rmsd_59 = QLabel("        track_out_of_sample_rmsd")
        label_track_out_of_sample_rmsd_59.setPalette(palette_object)
        label_track_out_of_sample_rmsd_59.setFont(QFont("Monospace"))
        hbox_lay_track_out_of_sample_rmsd_59.addWidget(label_track_out_of_sample_rmsd_59)

        box_track_out_of_sample_rmsd_59 = QComboBox()
        box_track_out_of_sample_rmsd_59.local_path = "refinement.refinery.track_out_of_sample_rmsd"
        box_track_out_of_sample_rmsd_59.tmp_lst=[]
        box_track_out_of_sample_rmsd_59.tmp_lst.append("True")
        box_track_out_of_sample_rmsd_59.tmp_lst.append("False")
        for lst_itm in box_track_out_of_sample_rmsd_59.tmp_lst:
            box_track_out_of_sample_rmsd_59.addItem(lst_itm)
        box_track_out_of_sample_rmsd_59.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_track_out_of_sample_rmsd_59.addWidget(box_track_out_of_sample_rmsd_59)
        bg_box.addLayout(hbox_lay_track_out_of_sample_rmsd_59)

        hbox_lay_max_iterations_61 =  QHBoxLayout()
        label_max_iterations_61 = QLabel("        max_iterations")
        label_max_iterations_61.setPalette(palette_object)
        label_max_iterations_61.setFont(QFont("Monospace"))
        hbox_lay_max_iterations_61.addWidget(label_max_iterations_61)

        box_max_iterations_61 = QSpinBox()
        box_max_iterations_61.local_path = "refinement.refinery.max_iterations"
        box_max_iterations_61.valueChanged.connect(self.spnbox_changed)
        hbox_lay_max_iterations_61.addWidget(box_max_iterations_61)
        bg_box.addLayout(hbox_lay_max_iterations_61)

        label_62 = QLabel("    target")
        label_62.setPalette(palette_scope)
        label_62.setFont(QFont("Monospace"))
        bg_box.addWidget(label_62)
        hbox_lay_rmsd_cutoff_63 =  QHBoxLayout()
        label_rmsd_cutoff_63 = QLabel("        rmsd_cutoff")
        label_rmsd_cutoff_63.setPalette(palette_object)
        label_rmsd_cutoff_63.setFont(QFont("Monospace"))
        hbox_lay_rmsd_cutoff_63.addWidget(label_rmsd_cutoff_63)

        box_rmsd_cutoff_63 = QComboBox()
        box_rmsd_cutoff_63.local_path = "refinement.target.rmsd_cutoff"
        box_rmsd_cutoff_63.tmp_lst=[]
        box_rmsd_cutoff_63.tmp_lst.append("*fraction_of_bin_size")
        box_rmsd_cutoff_63.tmp_lst.append("absolute")
        for lst_itm in box_rmsd_cutoff_63.tmp_lst:
            box_rmsd_cutoff_63.addItem(lst_itm)
        box_rmsd_cutoff_63.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_rmsd_cutoff_63.addWidget(box_rmsd_cutoff_63)
        bg_box.addLayout(hbox_lay_rmsd_cutoff_63)

        hbox_lay_bin_size_fraction_64 =  QHBoxLayout()
        label_bin_size_fraction_64 = QLabel("        bin_size_fraction")
        label_bin_size_fraction_64.setPalette(palette_object)
        label_bin_size_fraction_64.setFont(QFont("Monospace"))
        hbox_lay_bin_size_fraction_64.addWidget(label_bin_size_fraction_64)

        box_bin_size_fraction_64 = QDoubleSpinBox()
        box_bin_size_fraction_64.local_path = "refinement.target.bin_size_fraction"
        box_bin_size_fraction_64.valueChanged.connect(self.spnbox_changed)
        hbox_lay_bin_size_fraction_64.addWidget(box_bin_size_fraction_64)
        bg_box.addLayout(hbox_lay_bin_size_fraction_64)

        hbox_lay_absolute_cutoffs_65_0 =  QHBoxLayout()
        label_absolute_cutoffs_65_0 = QLabel("        absolute_cutoffs[1]")
        label_absolute_cutoffs_65_0.setPalette(palette_object)
        label_absolute_cutoffs_65_0.setFont(QFont("Monospace"))
        hbox_lay_absolute_cutoffs_65_0.addWidget(label_absolute_cutoffs_65_0)
        box_absolute_cutoffs_65_0 = QDoubleSpinBox()
        box_absolute_cutoffs_65_0.local_path = "refinement.target.absolute_cutoffs"
        #box_absolute_cutoffs_65_0.valueChanged.connect(self.spnbox_changed)
        hbox_lay_absolute_cutoffs_65_1 =  QHBoxLayout()
        label_absolute_cutoffs_65_1 = QLabel("        absolute_cutoffs[2]")
        label_absolute_cutoffs_65_1.setPalette(palette_object)
        label_absolute_cutoffs_65_1.setFont(QFont("Monospace"))
        hbox_lay_absolute_cutoffs_65_1.addWidget(label_absolute_cutoffs_65_1)
        box_absolute_cutoffs_65_1 = QDoubleSpinBox()
        box_absolute_cutoffs_65_1.local_path = "refinement.target.absolute_cutoffs"
        #box_absolute_cutoffs_65_1.valueChanged.connect(self.spnbox_changed)
        hbox_lay_absolute_cutoffs_65_2 =  QHBoxLayout()
        label_absolute_cutoffs_65_2 = QLabel("        absolute_cutoffs[3]")
        label_absolute_cutoffs_65_2.setPalette(palette_object)
        label_absolute_cutoffs_65_2.setFont(QFont("Monospace"))
        hbox_lay_absolute_cutoffs_65_2.addWidget(label_absolute_cutoffs_65_2)
        box_absolute_cutoffs_65_2 = QDoubleSpinBox()
        box_absolute_cutoffs_65_2.local_path = "refinement.target.absolute_cutoffs"
        #box_absolute_cutoffs_65_2.valueChanged.connect(self.spnbox_changed)
        hbox_lay_absolute_cutoffs_65_0.addWidget(box_absolute_cutoffs_65_0)
        bg_box.addLayout(hbox_lay_absolute_cutoffs_65_0)

        hbox_lay_absolute_cutoffs_65_1.addWidget(box_absolute_cutoffs_65_1)
        bg_box.addLayout(hbox_lay_absolute_cutoffs_65_1)

        hbox_lay_absolute_cutoffs_65_2.addWidget(box_absolute_cutoffs_65_2)
        bg_box.addLayout(hbox_lay_absolute_cutoffs_65_2)

        hbox_lay_gradient_calculation_blocksize_66 =  QHBoxLayout()
        label_gradient_calculation_blocksize_66 = QLabel("        gradient_calculation_blocksize")
        label_gradient_calculation_blocksize_66.setPalette(palette_object)
        label_gradient_calculation_blocksize_66.setFont(QFont("Monospace"))
        hbox_lay_gradient_calculation_blocksize_66.addWidget(label_gradient_calculation_blocksize_66)

        box_gradient_calculation_blocksize_66 = QSpinBox()
        box_gradient_calculation_blocksize_66.local_path = "refinement.target.gradient_calculation_blocksize"
        box_gradient_calculation_blocksize_66.valueChanged.connect(self.spnbox_changed)
        hbox_lay_gradient_calculation_blocksize_66.addWidget(box_gradient_calculation_blocksize_66)
        bg_box.addLayout(hbox_lay_gradient_calculation_blocksize_66)

        label_67 = QLabel("    reflections")
        label_67.setPalette(palette_scope)
        label_67.setFont(QFont("Monospace"))
        bg_box.addWidget(label_67)
        hbox_lay_reflections_per_degree_68 =  QHBoxLayout()
        label_reflections_per_degree_68 = QLabel("        reflections_per_degree")
        label_reflections_per_degree_68.setPalette(palette_object)
        label_reflections_per_degree_68.setFont(QFont("Monospace"))
        hbox_lay_reflections_per_degree_68.addWidget(label_reflections_per_degree_68)

        box_reflections_per_degree_68 = QDoubleSpinBox()
        box_reflections_per_degree_68.local_path = "refinement.reflections.reflections_per_degree"
        box_reflections_per_degree_68.valueChanged.connect(self.spnbox_changed)
        hbox_lay_reflections_per_degree_68.addWidget(box_reflections_per_degree_68)
        bg_box.addLayout(hbox_lay_reflections_per_degree_68)

        hbox_lay_minimum_sample_size_69 =  QHBoxLayout()
        label_minimum_sample_size_69 = QLabel("        minimum_sample_size")
        label_minimum_sample_size_69.setPalette(palette_object)
        label_minimum_sample_size_69.setFont(QFont("Monospace"))
        hbox_lay_minimum_sample_size_69.addWidget(label_minimum_sample_size_69)

        box_minimum_sample_size_69 = QSpinBox()
        box_minimum_sample_size_69.local_path = "refinement.reflections.minimum_sample_size"
        box_minimum_sample_size_69.valueChanged.connect(self.spnbox_changed)
        hbox_lay_minimum_sample_size_69.addWidget(box_minimum_sample_size_69)
        bg_box.addLayout(hbox_lay_minimum_sample_size_69)

        hbox_lay_maximum_sample_size_70 =  QHBoxLayout()
        label_maximum_sample_size_70 = QLabel("        maximum_sample_size")
        label_maximum_sample_size_70.setPalette(palette_object)
        label_maximum_sample_size_70.setFont(QFont("Monospace"))
        hbox_lay_maximum_sample_size_70.addWidget(label_maximum_sample_size_70)

        box_maximum_sample_size_70 = QSpinBox()
        box_maximum_sample_size_70.local_path = "refinement.reflections.maximum_sample_size"
        box_maximum_sample_size_70.valueChanged.connect(self.spnbox_changed)
        hbox_lay_maximum_sample_size_70.addWidget(box_maximum_sample_size_70)
        bg_box.addLayout(hbox_lay_maximum_sample_size_70)

        hbox_lay_random_seed_71 =  QHBoxLayout()
        label_random_seed_71 = QLabel("        random_seed")
        label_random_seed_71.setPalette(palette_object)
        label_random_seed_71.setFont(QFont("Monospace"))
        hbox_lay_random_seed_71.addWidget(label_random_seed_71)

        box_random_seed_71 = QSpinBox()
        box_random_seed_71.local_path = "refinement.reflections.random_seed"
        box_random_seed_71.valueChanged.connect(self.spnbox_changed)
        hbox_lay_random_seed_71.addWidget(box_random_seed_71)
        bg_box.addLayout(hbox_lay_random_seed_71)

        hbox_lay_close_to_spindle_cutoff_72 =  QHBoxLayout()
        label_close_to_spindle_cutoff_72 = QLabel("        close_to_spindle_cutoff")
        label_close_to_spindle_cutoff_72.setPalette(palette_object)
        label_close_to_spindle_cutoff_72.setFont(QFont("Monospace"))
        hbox_lay_close_to_spindle_cutoff_72.addWidget(label_close_to_spindle_cutoff_72)

        box_close_to_spindle_cutoff_72 = QDoubleSpinBox()
        box_close_to_spindle_cutoff_72.local_path = "refinement.reflections.close_to_spindle_cutoff"
        box_close_to_spindle_cutoff_72.valueChanged.connect(self.spnbox_changed)
        hbox_lay_close_to_spindle_cutoff_72.addWidget(box_close_to_spindle_cutoff_72)
        bg_box.addLayout(hbox_lay_close_to_spindle_cutoff_72)

        hbox_lay_block_width_73 =  QHBoxLayout()
        label_block_width_73 = QLabel("        block_width")
        label_block_width_73.setPalette(palette_object)
        label_block_width_73.setFont(QFont("Monospace"))
        hbox_lay_block_width_73.addWidget(label_block_width_73)

        box_block_width_73 = QDoubleSpinBox()
        box_block_width_73.local_path = "refinement.reflections.block_width"
        box_block_width_73.valueChanged.connect(self.spnbox_changed)
        hbox_lay_block_width_73.addWidget(box_block_width_73)
        bg_box.addLayout(hbox_lay_block_width_73)

        label_74 = QLabel("        weighting_strategy")
        label_74.setPalette(palette_scope)
        label_74.setFont(QFont("Monospace"))
        bg_box.addWidget(label_74)
        hbox_lay_override_75 =  QHBoxLayout()
        label_override_75 = QLabel("            override")
        label_override_75.setPalette(palette_object)
        label_override_75.setFont(QFont("Monospace"))
        hbox_lay_override_75.addWidget(label_override_75)

        box_override_75 = QComboBox()
        box_override_75.local_path = "refinement.reflections.weighting_strategy.override"
        box_override_75.tmp_lst=[]
        box_override_75.tmp_lst.append("statistical")
        box_override_75.tmp_lst.append("stills")
        box_override_75.tmp_lst.append("constant")
        for lst_itm in box_override_75.tmp_lst:
            box_override_75.addItem(lst_itm)
        box_override_75.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_override_75.addWidget(box_override_75)
        bg_box.addLayout(hbox_lay_override_75)

        hbox_lay_delpsi_constant_76 =  QHBoxLayout()
        label_delpsi_constant_76 = QLabel("            delpsi_constant")
        label_delpsi_constant_76.setPalette(palette_object)
        label_delpsi_constant_76.setFont(QFont("Monospace"))
        hbox_lay_delpsi_constant_76.addWidget(label_delpsi_constant_76)

        box_delpsi_constant_76 = QDoubleSpinBox()
        box_delpsi_constant_76.local_path = "refinement.reflections.weighting_strategy.delpsi_constant"
        box_delpsi_constant_76.valueChanged.connect(self.spnbox_changed)
        hbox_lay_delpsi_constant_76.addWidget(box_delpsi_constant_76)
        bg_box.addLayout(hbox_lay_delpsi_constant_76)

        hbox_lay_constants_77_0 =  QHBoxLayout()
        label_constants_77_0 = QLabel("            constants[1]")
        label_constants_77_0.setPalette(palette_object)
        label_constants_77_0.setFont(QFont("Monospace"))
        hbox_lay_constants_77_0.addWidget(label_constants_77_0)
        box_constants_77_0 = QDoubleSpinBox()
        box_constants_77_0.local_path = "refinement.reflections.weighting_strategy.constants"
        #box_constants_77_0.valueChanged.connect(self.spnbox_changed)
        hbox_lay_constants_77_1 =  QHBoxLayout()
        label_constants_77_1 = QLabel("            constants[2]")
        label_constants_77_1.setPalette(palette_object)
        label_constants_77_1.setFont(QFont("Monospace"))
        hbox_lay_constants_77_1.addWidget(label_constants_77_1)
        box_constants_77_1 = QDoubleSpinBox()
        box_constants_77_1.local_path = "refinement.reflections.weighting_strategy.constants"
        #box_constants_77_1.valueChanged.connect(self.spnbox_changed)
        hbox_lay_constants_77_2 =  QHBoxLayout()
        label_constants_77_2 = QLabel("            constants[3]")
        label_constants_77_2.setPalette(palette_object)
        label_constants_77_2.setFont(QFont("Monospace"))
        hbox_lay_constants_77_2.addWidget(label_constants_77_2)
        box_constants_77_2 = QDoubleSpinBox()
        box_constants_77_2.local_path = "refinement.reflections.weighting_strategy.constants"
        #box_constants_77_2.valueChanged.connect(self.spnbox_changed)
        hbox_lay_constants_77_0.addWidget(box_constants_77_0)
        bg_box.addLayout(hbox_lay_constants_77_0)

        hbox_lay_constants_77_1.addWidget(box_constants_77_1)
        bg_box.addLayout(hbox_lay_constants_77_1)

        hbox_lay_constants_77_2.addWidget(box_constants_77_2)
        bg_box.addLayout(hbox_lay_constants_77_2)

        label_78 = QLabel("        outlier")
        ...
        box_algorithm_79.local_path = "refinement.reflections.outlier.algorithm"
        box_algorithm_79.tmp_lst=[]
        box_algorithm_79.tmp_lst.append("null")
        box_algorithm_79.tmp_lst.append("*auto")
        box_algorithm_79.tmp_lst.append("mcd")
        box_algorithm_79.tmp_lst.append("tukey")
        box_algorithm_79.tmp_lst.append("sauter_poon")
        ...
        hbox_lay_minimum_number_of_reflections_80 =  QHBoxLayout()
        label_minimum_number_of_reflections_80 = QLabel("            minimum_number_of_reflections")
        label_minimum_number_of_reflections_80.setPalette(palette_object)
        label_minimum_number_of_reflections_80.setFont(QFont("Monospace"))
        hbox_lay_minimum_number_of_reflections_80.addWidget(label_minimum_number_of_reflections_80)

        box_minimum_number_of_reflections_80 = QSpinBox()
        box_minimum_number_of_reflections_80.local_path = "refinement.reflections.outlier.minimum_number_of_reflections"
        box_minimum_number_of_reflections_80.valueChanged.connect(self.spnbox_changed)
        hbox_lay_minimum_number_of_reflections_80.addWidget(box_minimum_number_of_reflections_80)
        bg_box.addLayout(hbox_lay_minimum_number_of_reflections_80)

        hbox_lay_separate_experiments_81 =  QHBoxLayout()
        label_separate_experiments_81 = QLabel("            separate_experiments")
        label_separate_experiments_81.setPalette(palette_object)
        label_separate_experiments_81.setFont(QFont("Monospace"))
        hbox_lay_separate_experiments_81.addWidget(label_separate_experiments_81)

        box_separate_experiments_81 = QComboBox()
        box_separate_experiments_81.local_path = "refinement.reflections.outlier.separate_experiments"
        box_separate_experiments_81.tmp_lst=[]
        box_separate_experiments_81.tmp_lst.append("True")
        box_separate_experiments_81.tmp_lst.append("False")
        for lst_itm in box_separate_experiments_81.tmp_lst:
            box_separate_experiments_81.addItem(lst_itm)
        box_separate_experiments_81.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_separate_experiments_81.addWidget(box_separate_experiments_81)
        bg_box.addLayout(hbox_lay_separate_experiments_81)

        hbox_lay_separate_panels_82 =  QHBoxLayout()
        label_separate_panels_82 = QLabel("            separate_panels")
        label_separate_panels_82.setPalette(palette_object)
        label_separate_panels_82.setFont(QFont("Monospace"))
        hbox_lay_separate_panels_82.addWidget(label_separate_panels_82)

        box_separate_panels_82 = QComboBox()
        box_separate_panels_82.local_path = "refinement.reflections.outlier.separate_panels"
        box_separate_panels_82.tmp_lst=[]
        box_separate_panels_82.tmp_lst.append("True")
        box_separate_panels_82.tmp_lst.append("False")
        for lst_itm in box_separate_panels_82.tmp_lst:
            box_separate_panels_82.addItem(lst_itm)
        box_separate_panels_82.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_separate_panels_82.addWidget(box_separate_panels_82)
        bg_box.addLayout(hbox_lay_separate_panels_82)

        label_83 = QLabel("            tukey")
        label_83.setPalette(palette_scope)
        label_83.setFont(QFont("Monospace"))
        bg_box.addWidget(label_83)
        hbox_lay_iqr_multiplier_84 =  QHBoxLayout()
        label_iqr_multiplier_84 = QLabel("                iqr_multiplier")
        label_iqr_multiplier_84.setPalette(palette_object)
        label_iqr_multiplier_84.setFont(QFont("Monospace"))
        hbox_lay_iqr_multiplier_84.addWidget(label_iqr_multiplier_84)

        box_iqr_multiplier_84 = QDoubleSpinBox()
        box_iqr_multiplier_84.local_path = "refinement.reflections.outlier.tukey.iqr_multiplier"
        box_iqr_multiplier_84.valueChanged.connect(self.spnbox_changed)
        hbox_lay_iqr_multiplier_84.addWidget(box_iqr_multiplier_84)
        bg_box.addLayout(hbox_lay_iqr_multiplier_84)

        label_85 = QLabel("            mcd")
        label_85.setPalette(palette_scope)
        label_85.setFont(QFont("Monospace"))
        bg_box.addWidget(label_85)
        hbox_lay_alpha_86 =  QHBoxLayout()
        label_alpha_86 = QLabel("                alpha")
        label_alpha_86.setPalette(palette_object)
        label_alpha_86.setFont(QFont("Monospace"))
        hbox_lay_alpha_86.addWidget(label_alpha_86)

        box_alpha_86 = QDoubleSpinBox()
        box_alpha_86.local_path = "refinement.reflections.outlier.mcd.alpha"
        box_alpha_86.valueChanged.connect(self.spnbox_changed)
        hbox_lay_alpha_86.addWidget(box_alpha_86)
        bg_box.addLayout(hbox_lay_alpha_86)

        hbox_lay_max_n_groups_87 =  QHBoxLayout()
        label_max_n_groups_87 = QLabel("                max_n_groups")
        label_max_n_groups_87.setPalette(palette_object)
        label_max_n_groups_87.setFont(QFont("Monospace"))
        hbox_lay_max_n_groups_87.addWidget(label_max_n_groups_87)

        box_max_n_groups_87 = QSpinBox()
        box_max_n_groups_87.local_path = "refinement.reflections.outlier.mcd.max_n_groups"
        box_max_n_groups_87.valueChanged.connect(self.spnbox_changed)
        hbox_lay_max_n_groups_87.addWidget(box_max_n_groups_87)
        bg_box.addLayout(hbox_lay_max_n_groups_87)

        hbox_lay_min_group_size_88 =  QHBoxLayout()
        label_min_group_size_88 = QLabel("                min_group_size")
        label_min_group_size_88.setPalette(palette_object)
        label_min_group_size_88.setFont(QFont("Monospace"))
        hbox_lay_min_group_size_88.addWidget(label_min_group_size_88)

        box_min_group_size_88 = QSpinBox()
        box_min_group_size_88.local_path = "refinement.reflections.outlier.mcd.min_group_size"
        box_min_group_size_88.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_group_size_88.addWidget(box_min_group_size_88)
        bg_box.addLayout(hbox_lay_min_group_size_88)

        hbox_lay_n_trials_89 =  QHBoxLayout()
        label_n_trials_89 = QLabel("                n_trials")
        label_n_trials_89.setPalette(palette_object)
        label_n_trials_89.setFont(QFont("Monospace"))
        hbox_lay_n_trials_89.addWidget(label_n_trials_89)

        box_n_trials_89 = QSpinBox()
        box_n_trials_89.local_path = "refinement.reflections.outlier.mcd.n_trials"
        box_n_trials_89.valueChanged.connect(self.spnbox_changed)
        hbox_lay_n_trials_89.addWidget(box_n_trials_89)
        bg_box.addLayout(hbox_lay_n_trials_89)

        hbox_lay_k1_90 =  QHBoxLayout()
        label_k1_90 = QLabel("                k1")
        label_k1_90.setPalette(palette_object)
        label_k1_90.setFont(QFont("Monospace"))
        hbox_lay_k1_90.addWidget(label_k1_90)

        box_k1_90 = QSpinBox()
        box_k1_90.local_path = "refinement.reflections.outlier.mcd.k1"
        box_k1_90.valueChanged.connect(self.spnbox_changed)
        hbox_lay_k1_90.addWidget(box_k1_90)
        bg_box.addLayout(hbox_lay_k1_90)

        hbox_lay_k2_91 =  QHBoxLayout()
        label_k2_91 = QLabel("                k2")
        label_k2_91.setPalette(palette_object)
        label_k2_91.setFont(QFont("Monospace"))
        hbox_lay_k2_91.addWidget(label_k2_91)

        box_k2_91 = QSpinBox()
        box_k2_91.local_path = "refinement.reflections.outlier.mcd.k2"
        box_k2_91.valueChanged.connect(self.spnbox_changed)
        hbox_lay_k2_91.addWidget(box_k2_91)
        bg_box.addLayout(hbox_lay_k2_91)

        hbox_lay_k3_92 =  QHBoxLayout()
        label_k3_92 = QLabel("                k3")
        label_k3_92.setPalette(palette_object)
        label_k3_92.setFont(QFont("Monospace"))
        hbox_lay_k3_92.addWidget(label_k3_92)

        box_k3_92 = QSpinBox()
        box_k3_92.local_path = "refinement.reflections.outlier.mcd.k3"
        box_k3_92.valueChanged.connect(self.spnbox_changed)
        hbox_lay_k3_92.addWidget(box_k3_92)
        bg_box.addLayout(hbox_lay_k3_92)

        hbox_lay_threshold_probability_93 =  QHBoxLayout()
        label_threshold_probability_93 = QLabel("                threshold_probability")
        label_threshold_probability_93.setPalette(palette_object)
        label_threshold_probability_93.setFont(QFont("Monospace"))
        hbox_lay_threshold_probability_93.addWidget(label_threshold_probability_93)

        box_threshold_probability_93 = QDoubleSpinBox()
        box_threshold_probability_93.local_path = "refinement.reflections.outlier.mcd.threshold_probability"
        box_threshold_probability_93.valueChanged.connect(self.spnbox_changed)
        hbox_lay_threshold_probability_93.addWidget(box_threshold_probability_93)
        bg_box.addLayout(hbox_lay_threshold_probability_93)

        label_94 = QLabel("            sauter_poon")
        label_94.setPalette(palette_scope)
        label_94.setFont(QFont("Monospace"))
        bg_box.addWidget(label_94)
        hbox_lay_px_sz_95_0 =  QHBoxLayout()
        label_px_sz_95_0 = QLabel("                px_sz[1]")
        label_px_sz_95_0.setPalette(palette_object)
        label_px_sz_95_0.setFont(QFont("Monospace"))
        hbox_lay_px_sz_95_0.addWidget(label_px_sz_95_0)
        box_px_sz_95_0 = QDoubleSpinBox()
        box_px_sz_95_0.local_path = "refinement.reflections.outlier.sauter_poon.px_sz"
        #box_px_sz_95_0.valueChanged.connect(self.spnbox_changed)
        hbox_lay_px_sz_95_1 =  QHBoxLayout()
        label_px_sz_95_1 = QLabel("                px_sz[2]")
        label_px_sz_95_1.setPalette(palette_object)
        label_px_sz_95_1.setFont(QFont("Monospace"))
        hbox_lay_px_sz_95_1.addWidget(label_px_sz_95_1)
        box_px_sz_95_1 = QDoubleSpinBox()
        box_px_sz_95_1.local_path = "refinement.reflections.outlier.sauter_poon.px_sz"
        #box_px_sz_95_1.valueChanged.connect(self.spnbox_changed)
        hbox_lay_px_sz_95_0.addWidget(box_px_sz_95_0)
        bg_box.addLayout(hbox_lay_px_sz_95_0)

        hbox_lay_px_sz_95_1.addWidget(box_px_sz_95_1)
        bg_box.addLayout(hbox_lay_px_sz_95_1)

        hbox_lay_verbose_96 =  QHBoxLayout()
        label_verbose_96 = QLabel("                verbose")
        label_verbose_96.setPalette(palette_object)
        label_verbose_96.setFont(QFont("Monospace"))
        hbox_lay_verbose_96.addWidget(label_verbose_96)

        box_verbose_96 = QComboBox()
        box_verbose_96.local_path = "refinement.reflections.outlier.sauter_poon.verbose"
        box_verbose_96.tmp_lst=[]
        box_verbose_96.tmp_lst.append("True")
        box_verbose_96.tmp_lst.append("False")
        for lst_itm in box_verbose_96.tmp_lst:
            box_verbose_96.addItem(lst_itm)
        box_verbose_96.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_verbose_96.addWidget(box_verbose_96)
        bg_box.addLayout(hbox_lay_verbose_96)

        hbox_lay_pdf_97 =  QHBoxLayout()
        label_pdf_97 = QLabel("                pdf")
        label_pdf_97.setPalette(palette_object)
        label_pdf_97.setFont(QFont("Monospace"))
        hbox_lay_pdf_97.addWidget(label_pdf_97)

        box_pdf_97 = QLineEdit()
        box_pdf_97.local_path = "refinement.reflections.outlier.sauter_poon.pdf"
        box_pdf_97.textChanged.connect(self.spnbox_changed)
        hbox_lay_pdf_97.addWidget(box_pdf_97)
        bg_box.addLayout(hbox_lay_pdf_97)
