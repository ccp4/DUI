...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        label_hklout_6.setFont(QFont("Monospace", 10))
        ...
        label_hklout_8.setFont(QFont("Monospace", 10))
        ...
        label_directory_10.setFont(QFont("Monospace", 10))
        ...
        label_directory_12.setFont(QFont("Monospace", 10))
        ...
        label_log_14.setFont(QFont("Monospace", 10))
        ...
        label_debug_log_15.setFont(QFont("Monospace", 10))
