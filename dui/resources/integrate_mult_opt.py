...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        label_scan_range_7_0.setFont(QFont("Monospace", 10))
        ...
        label_scan_range_7_1.setFont(QFont("Monospace", 10))
        ...
        label_reflections_per_degree_9.setFont(QFont("Monospace", 10))
        ...
        label_minimum_sample_size_10.setFont(QFont("Monospace", 10))
        ...
        label_maximum_sample_size_11.setFont(QFont("Monospace", 10))
        ...
        label_integrate_all_reflections_12.setFont(QFont("Monospace", 10))
        ...
        label_verbosity_13.setFont(QFont("Monospace", 10))
        ...
        label_method_16.setFont(QFont("Monospace", 10))
        ...
        label_nproc_17.setFont(QFont("Monospace", 10))
        ...
        label_nthreads_18.setFont(QFont("Monospace", 10))
        ...
        label_mask_20.setFont(QFont("Monospace", 10))
        ...
        label_size_22.setFont(QFont("Monospace", 10))
        ...
        label_units_23.setFont(QFont("Monospace", 10))
        ...
        label_threshold_24.setFont(QFont("Monospace", 10))
        ...
        label_force_25.setFont(QFont("Monospace", 10))
        ...
        label_max_memory_usage_26.setFont(QFont("Monospace", 10))
        ...
        label_output_29.setFont(QFont("Monospace", 10))
        ...
        label_during_30.setFont(QFont("Monospace", 10))
        ...
        label_separate_files_32.setFont(QFont("Monospace", 10))
        ...
        label_split_experiments_34.setFont(QFont("Monospace", 10))
        ...
        label_integrator_35.setFont(QFont("Monospace", 10))
        ...
        label_fitting_37.setFont(QFont("Monospace", 10))
        ...
        label_number_of_partitions_39.setFont(QFont("Monospace", 10))
        ...
        label_min_partition_size_40.setFont(QFont("Monospace", 10))
        ...
        label_min_zeta_42.setFont(QFont("Monospace", 10))
        ...
        label_max_shoebox_overlap_43.setFont(QFont("Monospace", 10))
        ...
        label_d_min_48.setFont(QFont("Monospace", 10))
        ...
        label_width_49.setFont(QFont("Monospace", 10))
        ...
        label_apply_50.setFont(QFont("Monospace", 10))
        ...
        label_algorithm_52.setFont(QFont("Monospace", 10))
        ...
        label_algorithm_55.setFont(QFont("Monospace", 10))
        ...
        label_lower_57.setFont(QFont("Monospace", 10))
        ...
        label_upper_58.setFont(QFont("Monospace", 10))
        ...
        label_lower_60.setFont(QFont("Monospace", 10))
        ...
        label_upper_61.setFont(QFont("Monospace", 10))
        ...
        label_62.setFont(QFont("Monospace", 10, QFont.Bold))
        ...
        label_min_pixels_63.setFont(QFont("Monospace", 10))
        ...
        label_fraction_65.setFont(QFont("Monospace", 10))
        ...
        label_n_sigma_66.setFont(QFont("Monospace", 10))
        ...
        label_lower_68.setFont(QFont("Monospace", 10))
        ...
        label_upper_69.setFont(QFont("Monospace", 10))
        ...
        label_algorithm_71.setFont(QFont("Monospace", 10))
        ...
        label_tuning_constant_74.setFont(QFont("Monospace", 10))
        ...
        label_algorithm_76.setFont(QFont("Monospace", 10))
        ...
        label_scan_varying_83.setFont(QFont("Monospace", 10))
        ...
        label_min_spots_84.setFont(QFont("Monospace", 10))
        ...
        label_min_zeta_86.setFont(QFont("Monospace", 10))
        ...
        label_scan_step_88.setFont(QFont("Monospace", 10))
        ...
        label_grid_size_89.setFont(QFont("Monospace", 10))
        ...
        label_threshold_90.setFont(QFont("Monospace", 10))
        ...
        label_grid_method_91.setFont(QFont("Monospace", 10))
        ...
        label_fit_method_92.setFont(QFont("Monospace", 10))
        ...
        label_d_min_94.setFont(QFont("Monospace", 10))
        ...
        label_d_max_95.setFont(QFont("Monospace", 10))
        ...
        label_margin_96.setFont(QFont("Monospace", 10))
        ...
        label_force_static_97.setFont(QFont("Monospace", 10))
