...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        box_algorithm_54.setCurrentIndex(2)
        ...
        label_75 = QLabel("            robust")
        label_75.setPalette(palette_scope)
        label_75.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_75)

        hbox_lay_tuning_constant_76 =  QHBoxLayout()
        label_tuning_constant_76 = QLabel("                tuning_constant")
        label_tuning_constant_76.setPalette(palette_object)
        label_tuning_constant_76.setFont(QFont("Monospace", 10))
        hbox_lay_tuning_constant_76.addWidget(label_tuning_constant_76)

        box_tuning_constant_76 = QDoubleSpinBox()
        box_tuning_constant_76.setValue(1.345)
        box_tuning_constant_76.local_path = "integration.background.glm.robust.tuning_constant"
        box_tuning_constant_76.valueChanged.connect(self.spnbox_changed)
        hbox_lay_tuning_constant_76.addWidget(box_tuning_constant_76)
        bg_box.addLayout(hbox_lay_tuning_constant_76)

        label_77 = QLabel("            model")
        ...
        box_algorithm_78.local_path = "integration.background.glm.model.algorithm"
        box_algorithm_78.tmp_lst=[]
        box_algorithm_78.tmp_lst.append("constant2d")
        box_algorithm_78.tmp_lst.append("constant3d")
        box_algorithm_78.tmp_lst.append("loglinear2d")
        box_algorithm_78.tmp_lst.append("loglinear3d")
        ...
        label_algorithm_81.setFont(QFont("Monospace", 10))
        hbox_lay_algorithm_81.addWidget(label_algorithm_81)

        box_algorithm_81 = QComboBox()
        box_algorithm_81.local_path = "integration.centroid.algorithm"
        box_algorithm_81.tmp_lst=[]
        box_algorithm_81.tmp_lst.append("simple")
        ...
        label_82 = QLabel("profile")
        label_82.setPalette(palette_scope)
        label_82.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_82)

        hbox_lay_algorithm_83 =  QHBoxLayout()
        label_algorithm_83 = QLabel("    algorithm")
        label_algorithm_83.setPalette(palette_object)
        label_algorithm_83.setFont(QFont("Monospace", 10))
        hbox_lay_algorithm_83.addWidget(label_algorithm_83)

        box_algorithm_83 = QComboBox()
        box_algorithm_83.local_path = "profile.algorithm"
        box_algorithm_83.tmp_lst=[]
        box_algorithm_83.tmp_lst.append("gaussian_rs")
        for lst_itm in box_algorithm_83.tmp_lst:
            box_algorithm_83.addItem(lst_itm)
        box_algorithm_83.setCurrentIndex(0)
        box_algorithm_83.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_algorithm_83.addWidget(box_algorithm_83)
        bg_box.addLayout(hbox_lay_algorithm_83)

        label_84 = QLabel("    gaussian_rs")
        label_84.setPalette(palette_scope)
        label_84.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_84)

        hbox_lay_scan_varying_85 =  QHBoxLayout()
        label_scan_varying_85 = QLabel("        scan_varying")
        label_scan_varying_85.setPalette(palette_object)
        label_scan_varying_85.setFont(QFont("Monospace", 10))
        hbox_lay_scan_varying_85.addWidget(label_scan_varying_85)

        box_scan_varying_85 = QComboBox()
        box_scan_varying_85.local_path = "profile.gaussian_rs.scan_varying"
        box_scan_varying_85.tmp_lst=[]
        box_scan_varying_85.tmp_lst.append("True")
        box_scan_varying_85.tmp_lst.append("False")
        for lst_itm in box_scan_varying_85.tmp_lst:
            box_scan_varying_85.addItem(lst_itm)
        box_scan_varying_85.setCurrentIndex(1)
        box_scan_varying_85.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_scan_varying_85.addWidget(box_scan_varying_85)
        bg_box.addLayout(hbox_lay_scan_varying_85)

        label_86 = QLabel("        min_spots")
        label_86.setPalette(palette_scope)
        label_86.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_86)

        hbox_lay_overall_87 =  QHBoxLayout()
        label_overall_87 = QLabel("            overall")
        label_overall_87.setPalette(palette_object)
        label_overall_87.setFont(QFont("Monospace", 10))
        hbox_lay_overall_87.addWidget(label_overall_87)

        box_overall_87 = QSpinBox()
        box_overall_87.setValue(100)
        box_overall_87.local_path = "profile.gaussian_rs.min_spots.overall"
        box_overall_87.valueChanged.connect(self.spnbox_changed)
        hbox_lay_overall_87.addWidget(box_overall_87)
        bg_box.addLayout(hbox_lay_overall_87)

        hbox_lay_per_degree_88 =  QHBoxLayout()
        label_per_degree_88 = QLabel("            per_degree")
        label_per_degree_88.setPalette(palette_object)
        label_per_degree_88.setFont(QFont("Monospace", 10))
        hbox_lay_per_degree_88.addWidget(label_per_degree_88)

        box_per_degree_88 = QSpinBox()
        box_per_degree_88.setValue(50)
        box_per_degree_88.local_path = "profile.gaussian_rs.min_spots.per_degree"
        box_per_degree_88.valueChanged.connect(self.spnbox_changed)
        hbox_lay_per_degree_88.addWidget(box_per_degree_88)
        bg_box.addLayout(hbox_lay_per_degree_88)

        label_89 = QLabel("        filter")
        label_89.setPalette(palette_scope)
        label_89.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_89)

        hbox_lay_min_zeta_90 =  QHBoxLayout()
        label_min_zeta_90 = QLabel("            min_zeta")
        label_min_zeta_90.setPalette(palette_object)
        label_min_zeta_90.setFont(QFont("Monospace", 10))
        hbox_lay_min_zeta_90.addWidget(label_min_zeta_90)

        box_min_zeta_90 = QDoubleSpinBox()
        box_min_zeta_90.setValue(0.05)
        box_min_zeta_90.local_path = "profile.gaussian_rs.filter.min_zeta"
        box_min_zeta_90.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_zeta_90.addWidget(box_min_zeta_90)
        bg_box.addLayout(hbox_lay_min_zeta_90)

        label_91 = QLabel("        fitting")
        label_91.setPalette(palette_scope)
        label_91.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_91)

        hbox_lay_scan_step_92 =  QHBoxLayout()
        label_scan_step_92 = QLabel("            scan_step")
        label_scan_step_92.setPalette(palette_object)
        label_scan_step_92.setFont(QFont("Monospace", 10))
        hbox_lay_scan_step_92.addWidget(label_scan_step_92)

        box_scan_step_92 = QDoubleSpinBox()
        box_scan_step_92.setValue(5.0)
        box_scan_step_92.local_path = "profile.gaussian_rs.fitting.scan_step"
        box_scan_step_92.valueChanged.connect(self.spnbox_changed)
        hbox_lay_scan_step_92.addWidget(box_scan_step_92)
        bg_box.addLayout(hbox_lay_scan_step_92)

        hbox_lay_grid_size_93 =  QHBoxLayout()
        label_grid_size_93 = QLabel("            grid_size")
        label_grid_size_93.setPalette(palette_object)
        label_grid_size_93.setFont(QFont("Monospace", 10))
        hbox_lay_grid_size_93.addWidget(label_grid_size_93)

        box_grid_size_93 = QSpinBox()
        box_grid_size_93.setValue(5)
        box_grid_size_93.local_path = "profile.gaussian_rs.fitting.grid_size"
        box_grid_size_93.valueChanged.connect(self.spnbox_changed)
        hbox_lay_grid_size_93.addWidget(box_grid_size_93)
        bg_box.addLayout(hbox_lay_grid_size_93)

        hbox_lay_threshold_94 =  QHBoxLayout()
        label_threshold_94 = QLabel("            threshold")
        label_threshold_94.setPalette(palette_object)
        label_threshold_94.setFont(QFont("Monospace", 10))
        hbox_lay_threshold_94.addWidget(label_threshold_94)

        box_threshold_94 = QDoubleSpinBox()
        box_threshold_94.setValue(0.02)
        box_threshold_94.local_path = "profile.gaussian_rs.fitting.threshold"
        box_threshold_94.valueChanged.connect(self.spnbox_changed)
        hbox_lay_threshold_94.addWidget(box_threshold_94)
        bg_box.addLayout(hbox_lay_threshold_94)

        hbox_lay_grid_method_95 =  QHBoxLayout()
        label_grid_method_95 = QLabel("            grid_method")
        label_grid_method_95.setPalette(palette_object)
        label_grid_method_95.setFont(QFont("Monospace", 10))
        hbox_lay_grid_method_95.addWidget(label_grid_method_95)

        box_grid_method_95 = QComboBox()
        box_grid_method_95.local_path = "profile.gaussian_rs.fitting.grid_method"
        box_grid_method_95.tmp_lst=[]
        box_grid_method_95.tmp_lst.append("single")
        box_grid_method_95.tmp_lst.append("regular_grid")
        box_grid_method_95.tmp_lst.append("circular_grid")
        for lst_itm in box_grid_method_95.tmp_lst:
            box_grid_method_95.addItem(lst_itm)
        box_grid_method_95.setCurrentIndex(1)
        box_grid_method_95.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_grid_method_95.addWidget(box_grid_method_95)
        bg_box.addLayout(hbox_lay_grid_method_95)

        hbox_lay_fit_method_96 =  QHBoxLayout()
        label_fit_method_96 = QLabel("            fit_method")
        label_fit_method_96.setPalette(palette_object)
        label_fit_method_96.setFont(QFont("Monospace", 10))
        hbox_lay_fit_method_96.addWidget(label_fit_method_96)

        box_fit_method_96 = QComboBox()
        box_fit_method_96.local_path = "profile.gaussian_rs.fitting.fit_method"
        box_fit_method_96.tmp_lst=[]
        box_fit_method_96.tmp_lst.append("reciprocal_space")
        box_fit_method_96.tmp_lst.append("detector_space")
        for lst_itm in box_fit_method_96.tmp_lst:
            box_fit_method_96.addItem(lst_itm)
        box_fit_method_96.setCurrentIndex(0)
        box_fit_method_96.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_fit_method_96.addWidget(box_fit_method_96)
        bg_box.addLayout(hbox_lay_fit_method_96)

        label_97 = QLabel("prediction")
        label_97.setPalette(palette_scope)
        label_97.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_97)

        hbox_lay_d_min_98 =  QHBoxLayout()
        label_d_min_98 = QLabel("    d_min")
        label_d_min_98.setPalette(palette_object)
        label_d_min_98.setFont(QFont("Monospace", 10))
        hbox_lay_d_min_98.addWidget(label_d_min_98)

        box_d_min_98 = QDoubleSpinBox()
        box_d_min_98.local_path = "prediction.d_min"
        box_d_min_98.valueChanged.connect(self.spnbox_changed)
        hbox_lay_d_min_98.addWidget(box_d_min_98)
        bg_box.addLayout(hbox_lay_d_min_98)

        hbox_lay_d_max_99 =  QHBoxLayout()
        label_d_max_99 = QLabel("    d_max")
        label_d_max_99.setPalette(palette_object)
        label_d_max_99.setFont(QFont("Monospace", 10))
        hbox_lay_d_max_99.addWidget(label_d_max_99)

        box_d_max_99 = QDoubleSpinBox()
        box_d_max_99.local_path = "prediction.d_max"
        box_d_max_99.valueChanged.connect(self.spnbox_changed)
        hbox_lay_d_max_99.addWidget(box_d_max_99)
        bg_box.addLayout(hbox_lay_d_max_99)

        hbox_lay_margin_100 =  QHBoxLayout()
        label_margin_100 = QLabel("    margin")
        label_margin_100.setPalette(palette_object)
        label_margin_100.setFont(QFont("Monospace", 10))
        hbox_lay_margin_100.addWidget(label_margin_100)

        box_margin_100 = QSpinBox()
        box_margin_100.setValue(1)
        box_margin_100.local_path = "prediction.margin"
        box_margin_100.valueChanged.connect(self.spnbox_changed)
        hbox_lay_margin_100.addWidget(box_margin_100)
        bg_box.addLayout(hbox_lay_margin_100)

        hbox_lay_force_static_101 =  QHBoxLayout()
        label_force_static_101 = QLabel("    force_static")
        label_force_static_101.setPalette(palette_object)
        label_force_static_101.setFont(QFont("Monospace", 10))
        hbox_lay_force_static_101.addWidget(label_force_static_101)

        box_force_static_101 = QComboBox()
        box_force_static_101.local_path = "prediction.force_static"
        box_force_static_101.tmp_lst=[]
        box_force_static_101.tmp_lst.append("True")
        box_force_static_101.tmp_lst.append("False")
        for lst_itm in box_force_static_101.tmp_lst:
            box_force_static_101.addItem(lst_itm)
        box_force_static_101.setCurrentIndex(1)
        box_force_static_101.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_force_static_101.addWidget(box_force_static_101)
        bg_box.addLayout(hbox_lay_force_static_101)
