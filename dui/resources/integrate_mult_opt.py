...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        label_include_bad_reference_7.setFont(QFont("Monospace"))
        ...
        label_scan_range_8_0.setFont(QFont("Monospace"))
        ...
        label_scan_range_8_1.setFont(QFont("Monospace"))
        ...
        label_reflections_per_degree_10.setFont(QFont("Monospace"))
        ...
        label_minimum_sample_size_11.setFont(QFont("Monospace"))
        ...
        label_maximum_sample_size_12.setFont(QFont("Monospace"))
        ...
        label_integrate_all_reflections_13.setFont(QFont("Monospace"))
        ...
        label_verbosity_14.setFont(QFont("Monospace"))
        ...
        label_16.setFont(QFont("Monospace"))
        ...
        label_method_17.setFont(QFont("Monospace"))
        ...
        label_nproc_18.setFont(QFont("Monospace"))
        ...
        label_nthreads_19.setFont(QFont("Monospace"))
        ...
        label_mask_21.setFont(QFont("Monospace"))
        ...
        label_size_23.setFont(QFont("Monospace"))
        ...
        label_units_24.setFont(QFont("Monospace"))
        ...
        label_threshold_25.setFont(QFont("Monospace"))
        ...
        label_force_26.setFont(QFont("Monospace"))
        ...
        label_max_memory_usage_27.setFont(QFont("Monospace"))
        ...
        label_output_30.setFont(QFont("Monospace"))
        ...
        label_during_31.setFont(QFont("Monospace"))
        ...
        label_output_32.setFont(QFont("Monospace"))
        ...
        label_separate_files_33.setFont(QFont("Monospace"))
        ...
        label_split_experiments_35.setFont(QFont("Monospace"))
        ...
        label_integrator_36.setFont(QFont("Monospace"))
        ...
        label_37.setFont(QFont("Monospace"))
        ...
        label_fitting_38.setFont(QFont("Monospace"))
        ...
        label_number_of_partitions_40.setFont(QFont("Monospace"))
        ...
        label_min_partition_size_41.setFont(QFont("Monospace"))
        ...
        label_42.setFont(QFont("Monospace"))
        ...
        label_min_zeta_43.setFont(QFont("Monospace"))
        ...
        label_max_shoebox_overlap_44.setFont(QFont("Monospace"))
        ...
        label_d_min_49.setFont(QFont("Monospace"))
        ...
        label_width_50.setFont(QFont("Monospace"))
        ...
        label_apply_51.setFont(QFont("Monospace"))
        ...
        label_algorithm_53.setFont(QFont("Monospace"))
        ...
        label_55.setFont(QFont("Monospace"))
        ...
        label_algorithm_56.setFont(QFont("Monospace"))
        ...
        label_57.setFont(QFont("Monospace"))
        ...
        label_lower_58.setFont(QFont("Monospace"))
        ...
        label_upper_59.setFont(QFont("Monospace"))
        ...
        label_lower_61.setFont(QFont("Monospace"))
        ...
        label_upper_62.setFont(QFont("Monospace"))
        ...
        label_63.setFont(QFont("Monospace"))
        ...
        label_min_pixels_64.setFont(QFont("Monospace"))
        ...
        label_fraction_66.setFont(QFont("Monospace"))
        ...
        label_n_sigma_67.setFont(QFont("Monospace"))
        ...
        label_68.setFont(QFont("Monospace"))
        ...
        label_lower_69.setFont(QFont("Monospace"))
        ...
        label_upper_70.setFont(QFont("Monospace"))
        ...
        label_algorithm_72.setFont(QFont("Monospace"))
        ...
        label_tuning_constant_75.setFont(QFont("Monospace"))
        ...
        label_76.setFont(QFont("Monospace"))
        ...
        label_algorithm_77.setFont(QFont("Monospace"))
        ...
        label_algorithm_80.setFont(QFont("Monospace"))
        ...
        label_81.setFont(QFont("Monospace"))
        ...
        label_algorithm_82.setFont(QFont("Monospace"))
        ...
        label_scan_varying_84.setFont(QFont("Monospace"))
        ...
        hbox_lay_min_spots_85 =  QHBoxLayout()
        label_min_spots_85 = QLabel("        min_spots")
        label_min_spots_85.setPalette(palette_object)
        label_min_spots_85.setFont(QFont("Monospace"))
        hbox_lay_min_spots_85.addWidget(label_min_spots_85)

        box_min_spots_85 = QSpinBox()
        box_min_spots_85.local_path = "profile.gaussian_rs.min_spots"
        box_min_spots_85.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_spots_85.addWidget(box_min_spots_85)
        bg_box.addLayout(hbox_lay_min_spots_85)

        label_86 = QLabel("        filter")
        label_86.setPalette(palette_scope)
        label_86.setFont(QFont("Monospace"))
        bg_box.addWidget(label_86)
        hbox_lay_min_zeta_87 =  QHBoxLayout()
        label_min_zeta_87 = QLabel("            min_zeta")
        label_min_zeta_87.setPalette(palette_object)
        label_min_zeta_87.setFont(QFont("Monospace"))
        hbox_lay_min_zeta_87.addWidget(label_min_zeta_87)

        box_min_zeta_87 = QDoubleSpinBox()
        box_min_zeta_87.local_path = "profile.gaussian_rs.filter.min_zeta"
        box_min_zeta_87.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_zeta_87.addWidget(box_min_zeta_87)
        bg_box.addLayout(hbox_lay_min_zeta_87)

        label_88 = QLabel("        fitting")
        label_88.setPalette(palette_scope)
        label_88.setFont(QFont("Monospace"))
        bg_box.addWidget(label_88)
        hbox_lay_scan_step_89 =  QHBoxLayout()
        label_scan_step_89 = QLabel("            scan_step")
        label_scan_step_89.setPalette(palette_object)
        label_scan_step_89.setFont(QFont("Monospace"))
        hbox_lay_scan_step_89.addWidget(label_scan_step_89)

        box_scan_step_89 = QDoubleSpinBox()
        box_scan_step_89.local_path = "profile.gaussian_rs.fitting.scan_step"
        box_scan_step_89.valueChanged.connect(self.spnbox_changed)
        hbox_lay_scan_step_89.addWidget(box_scan_step_89)
        bg_box.addLayout(hbox_lay_scan_step_89)

        hbox_lay_grid_size_90 =  QHBoxLayout()
        label_grid_size_90 = QLabel("            grid_size")
        label_grid_size_90.setPalette(palette_object)
        label_grid_size_90.setFont(QFont("Monospace"))
        hbox_lay_grid_size_90.addWidget(label_grid_size_90)

        box_grid_size_90 = QSpinBox()
        box_grid_size_90.local_path = "profile.gaussian_rs.fitting.grid_size"
        box_grid_size_90.valueChanged.connect(self.spnbox_changed)
        hbox_lay_grid_size_90.addWidget(box_grid_size_90)
        bg_box.addLayout(hbox_lay_grid_size_90)

        hbox_lay_threshold_91 =  QHBoxLayout()
        label_threshold_91 = QLabel("            threshold")
        label_threshold_91.setPalette(palette_object)
        label_threshold_91.setFont(QFont("Monospace"))
        hbox_lay_threshold_91.addWidget(label_threshold_91)

        box_threshold_91 = QDoubleSpinBox()
        box_threshold_91.local_path = "profile.gaussian_rs.fitting.threshold"
        box_threshold_91.valueChanged.connect(self.spnbox_changed)
        hbox_lay_threshold_91.addWidget(box_threshold_91)
        bg_box.addLayout(hbox_lay_threshold_91)

        hbox_lay_grid_method_92 =  QHBoxLayout()
        label_grid_method_92 = QLabel("            grid_method")
        label_grid_method_92.setPalette(palette_object)
        label_grid_method_92.setFont(QFont("Monospace"))
        hbox_lay_grid_method_92.addWidget(label_grid_method_92)

        box_grid_method_92 = QComboBox()
        box_grid_method_92.local_path = "profile.gaussian_rs.fitting.grid_method"
        box_grid_method_92.tmp_lst=[]
        box_grid_method_92.tmp_lst.append("single")
        box_grid_method_92.tmp_lst.append("*regular_grid")
        box_grid_method_92.tmp_lst.append("circular_grid")
        for lst_itm in box_grid_method_92.tmp_lst:
            box_grid_method_92.addItem(lst_itm)
        box_grid_method_92.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_grid_method_92.addWidget(box_grid_method_92)
        bg_box.addLayout(hbox_lay_grid_method_92)

        hbox_lay_fit_method_93 =  QHBoxLayout()
        label_fit_method_93 = QLabel("            fit_method")
        label_fit_method_93.setPalette(palette_object)
        label_fit_method_93.setFont(QFont("Monospace"))
        hbox_lay_fit_method_93.addWidget(label_fit_method_93)

        box_fit_method_93 = QComboBox()
        box_fit_method_93.local_path = "profile.gaussian_rs.fitting.fit_method"
        box_fit_method_93.tmp_lst=[]
        box_fit_method_93.tmp_lst.append("*reciprocal_space")
        box_fit_method_93.tmp_lst.append("detector_space")
        for lst_itm in box_fit_method_93.tmp_lst:
            box_fit_method_93.addItem(lst_itm)
        box_fit_method_93.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_fit_method_93.addWidget(box_fit_method_93)
        bg_box.addLayout(hbox_lay_fit_method_93)

        label_94 = QLabel("prediction")
        label_94.setPalette(palette_scope)
        label_94.setFont(QFont("Monospace"))
        bg_box.addWidget(label_94)
        hbox_lay_d_min_95 =  QHBoxLayout()
        label_d_min_95 = QLabel("    d_min")
        label_d_min_95.setPalette(palette_object)
        label_d_min_95.setFont(QFont("Monospace"))
        hbox_lay_d_min_95.addWidget(label_d_min_95)

        box_d_min_95 = QDoubleSpinBox()
        box_d_min_95.local_path = "prediction.d_min"
        box_d_min_95.valueChanged.connect(self.spnbox_changed)
        hbox_lay_d_min_95.addWidget(box_d_min_95)
        bg_box.addLayout(hbox_lay_d_min_95)

        hbox_lay_d_max_96 =  QHBoxLayout()
        label_d_max_96 = QLabel("    d_max")
        label_d_max_96.setPalette(palette_object)
        label_d_max_96.setFont(QFont("Monospace"))
        hbox_lay_d_max_96.addWidget(label_d_max_96)

        box_d_max_96 = QDoubleSpinBox()
        box_d_max_96.local_path = "prediction.d_max"
        box_d_max_96.valueChanged.connect(self.spnbox_changed)
        hbox_lay_d_max_96.addWidget(box_d_max_96)
        bg_box.addLayout(hbox_lay_d_max_96)

        hbox_lay_margin_97 =  QHBoxLayout()
        label_margin_97 = QLabel("    margin")
        label_margin_97.setPalette(palette_object)
        label_margin_97.setFont(QFont("Monospace"))
        hbox_lay_margin_97.addWidget(label_margin_97)

        box_margin_97 = QSpinBox()
        box_margin_97.local_path = "prediction.margin"
        box_margin_97.valueChanged.connect(self.spnbox_changed)
        hbox_lay_margin_97.addWidget(box_margin_97)
        bg_box.addLayout(hbox_lay_margin_97)

        hbox_lay_force_static_98 =  QHBoxLayout()
        label_force_static_98 = QLabel("    force_static")
        label_force_static_98.setPalette(palette_object)
        label_force_static_98.setFont(QFont("Monospace"))
        hbox_lay_force_static_98.addWidget(label_force_static_98)

        box_force_static_98 = QComboBox()
        box_force_static_98.local_path = "prediction.force_static"
        box_force_static_98.tmp_lst=[]
        box_force_static_98.tmp_lst.append("True")
        box_force_static_98.tmp_lst.append("False")
        for lst_itm in box_force_static_98.tmp_lst:
            box_force_static_98.addItem(lst_itm)
        box_force_static_98.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_force_static_98.addWidget(box_force_static_98)
        bg_box.addLayout(hbox_lay_force_static_98)
