...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        label_max_separation_16.setFont(QFont("Monospace", 10))
        ...
        label_d_min_17.setFont(QFont("Monospace", 10))
        ...
        label_d_max_18.setFont(QFont("Monospace", 10))
        ...
        label_width_30.setFont(QFont("Monospace", 10))
        ...
        label_method_33.setFont(QFont("Monospace", 10))
        ...
        box_method_33.setCurrentIndex(0)
        ...
        label_nproc_34.setFont(QFont("Monospace", 10))
        ...
        label_chunksize_35.setFont(QFont("Monospace", 10))
        ...
        label_algorithm_37.setFont(QFont("Monospace", 10))
        ...
        box_algorithm_37.setCurrentIndex(0)
        ...
        label_gain_39.setFont(QFont("Monospace", 10))
        ...
        label_kernel_size_40_0.setFont(QFont("Monospace", 10))
        ...
        label_kernel_size_40_1.setFont(QFont("Monospace", 10))
        ...
        label_sigma_background_41.setFont(QFont("Monospace", 10))
        ...
        label_sigma_strong_42.setFont(QFont("Monospace", 10))
        ...
        label_min_local_43.setFont(QFont("Monospace", 10))
        ...
        label_global_threshold_44.setFont(QFont("Monospace", 10))
