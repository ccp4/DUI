...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        box_method_42.tmp_lst.append("none")
        ...
        hbox_lay_njobs_43 =  QHBoxLayout()
        label_njobs_43 = QLabel("        njobs")
        label_njobs_43.setPalette(palette_object)
        label_njobs_43.setFont(QFont("Monospace", 10))
        hbox_lay_njobs_43.addWidget(label_njobs_43)

        box_njobs_43 = QSpinBox()
        box_njobs_43.setValue(1)
        box_njobs_43.local_path = "spotfinder.mp.njobs"
        box_njobs_43.valueChanged.connect(self.spnbox_changed)
        hbox_lay_njobs_43.addWidget(box_njobs_43)
        bg_box.addLayout(hbox_lay_njobs_43)

        hbox_lay_nproc_44 =  QHBoxLayout()
        label_nproc_44 = QLabel("        nproc")
        label_nproc_44.setPalette(palette_object)
        label_nproc_44.setFont(QFont("Monospace", 10))
        hbox_lay_nproc_44.addWidget(label_nproc_44)

        box_nproc_44 = QSpinBox()
        box_nproc_44.setValue(1)
        box_nproc_44.local_path = "spotfinder.mp.nproc"
        box_nproc_44.valueChanged.connect(self.spnbox_changed)
        hbox_lay_nproc_44.addWidget(box_nproc_44)
        bg_box.addLayout(hbox_lay_nproc_44)

        hbox_lay_chunksize_45 =  QHBoxLayout()
        label_chunksize_45 = QLabel("        chunksize")
        label_chunksize_45.setPalette(palette_object)
        label_chunksize_45.setFont(QFont("Monospace", 10))
        ...
        bg_box.addLayout(hbox_lay_chunksize_45)

        label_46 = QLabel("    threshold")
        label_46.setPalette(palette_scope)
        label_46.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_46)

        hbox_lay_algorithm_47 =  QHBoxLayout()
        label_algorithm_47 = QLabel("        algorithm")
        label_algorithm_47.setPalette(palette_object)
        label_algorithm_47.setFont(QFont("Monospace", 10))
        hbox_lay_algorithm_47.addWidget(label_algorithm_47)

        box_algorithm_47 = QComboBox()
        box_algorithm_47.local_path = "spotfinder.threshold.algorithm"
        box_algorithm_47.tmp_lst=[]
        box_algorithm_47.tmp_lst.append("xds")
        for lst_itm in box_algorithm_47.tmp_lst:
            box_algorithm_47.addItem(lst_itm)
        box_algorithm_47.setCurrentIndex(0)
        box_algorithm_47.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_algorithm_47.addWidget(box_algorithm_47)
        bg_box.addLayout(hbox_lay_algorithm_47)
        ...
        hbox_lay_gain_49 =  QHBoxLayout()
        label_gain_49 = QLabel("            gain")
        label_gain_49.setPalette(palette_object)
        label_gain_49.setFont(QFont("Monospace", 10))
        hbox_lay_gain_49.addWidget(label_gain_49)

        box_gain_49 = QDoubleSpinBox()
        box_gain_49.local_path = "spotfinder.threshold.xds.gain"
        box_gain_49.valueChanged.connect(self.spnbox_changed)
        hbox_lay_gain_49.addWidget(box_gain_49)
        bg_box.addLayout(hbox_lay_gain_49)

        hbox_lay_kernel_size_50_0 =  QHBoxLayout()
        label_kernel_size_50_0 = QLabel("            kernel_size[1]")
        label_kernel_size_50_0.setPalette(palette_object)
        label_kernel_size_50_0.setFont(QFont("Monospace", 10))
        hbox_lay_kernel_size_50_0.addWidget(label_kernel_size_50_0)
        box_kernel_size_50_0 = QSpinBox()
        box_kernel_size_50_0.local_path = "spotfinder.threshold.xds.kernel_size"
        #box_kernel_size_50_0.valueChanged.connect(self.spnbox_changed)
        hbox_lay_kernel_size_50_1 =  QHBoxLayout()
        label_kernel_size_50_1 = QLabel("            kernel_size[2]")
        label_kernel_size_50_1.setPalette(palette_object)
        label_kernel_size_50_1.setFont(QFont("Monospace", 10))
        hbox_lay_kernel_size_50_1.addWidget(label_kernel_size_50_1)
        box_kernel_size_50_1 = QSpinBox()
        box_kernel_size_50_1.local_path = "spotfinder.threshold.xds.kernel_size"
        #box_kernel_size_50_1.valueChanged.connect(self.spnbox_changed)
        hbox_lay_kernel_size_50_0.addWidget(box_kernel_size_50_0)
        bg_box.addLayout(hbox_lay_kernel_size_50_0)
        hbox_lay_kernel_size_50_1.addWidget(box_kernel_size_50_1)
        bg_box.addLayout(hbox_lay_kernel_size_50_1)

        hbox_lay_sigma_background_51 =  QHBoxLayout()
        label_sigma_background_51 = QLabel("            sigma_background")
        label_sigma_background_51.setPalette(palette_object)
        label_sigma_background_51.setFont(QFont("Monospace", 10))
        hbox_lay_sigma_background_51.addWidget(label_sigma_background_51)

        box_sigma_background_51 = QDoubleSpinBox()
        box_sigma_background_51.setValue(6.0)
        box_sigma_background_51.local_path = "spotfinder.threshold.xds.sigma_background"
        box_sigma_background_51.valueChanged.connect(self.spnbox_changed)
        hbox_lay_sigma_background_51.addWidget(box_sigma_background_51)
        bg_box.addLayout(hbox_lay_sigma_background_51)

        hbox_lay_sigma_strong_52 =  QHBoxLayout()
        label_sigma_strong_52 = QLabel("            sigma_strong")
        label_sigma_strong_52.setPalette(palette_object)
        label_sigma_strong_52.setFont(QFont("Monospace", 10))
        hbox_lay_sigma_strong_52.addWidget(label_sigma_strong_52)

        box_sigma_strong_52 = QDoubleSpinBox()
        box_sigma_strong_52.setValue(3.0)
        box_sigma_strong_52.local_path = "spotfinder.threshold.xds.sigma_strong"
        box_sigma_strong_52.valueChanged.connect(self.spnbox_changed)
        hbox_lay_sigma_strong_52.addWidget(box_sigma_strong_52)
        bg_box.addLayout(hbox_lay_sigma_strong_52)

        hbox_lay_min_local_53 =  QHBoxLayout()
        label_min_local_53 = QLabel("            min_local")
        label_min_local_53.setPalette(palette_object)
        label_min_local_53.setFont(QFont("Monospace", 10))
        hbox_lay_min_local_53.addWidget(label_min_local_53)

        box_min_local_53 = QSpinBox()
        box_min_local_53.setValue(2)
        box_min_local_53.local_path = "spotfinder.threshold.xds.min_local"
        box_min_local_53.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_local_53.addWidget(box_min_local_53)
        bg_box.addLayout(hbox_lay_min_local_53)

        hbox_lay_global_threshold_54 =  QHBoxLayout()
        label_global_threshold_54 = QLabel("            global_threshold")
        label_global_threshold_54.setPalette(palette_object)
        label_global_threshold_54.setFont(QFont("Monospace", 10))
        hbox_lay_global_threshold_54.addWidget(label_global_threshold_54)

        box_global_threshold_54 = QDoubleSpinBox()
        box_global_threshold_54.setValue(0.0)
        box_global_threshold_54.local_path = "spotfinder.threshold.xds.global_threshold"
        box_global_threshold_54.valueChanged.connect(self.spnbox_changed)
