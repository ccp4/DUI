...
class inner_widg( QWidget):
    ...
    def __init__(self, parent = None):
        ...
        box_algorithm_54.tmp_lst.append("gmodel")
        ...
        box_algorithm_54.setCurrentIndex(4)
        ...
        hbox_lay_min_pixels_74 =  QHBoxLayout()
        label_min_pixels_74 = QLabel("            min_pixels")
        label_min_pixels_74.setPalette(palette_object)
        label_min_pixels_74.setFont(QFont("Monospace", 10))
        hbox_lay_min_pixels_74.addWidget(label_min_pixels_74)

        box_min_pixels_74 = QSpinBox()
        box_min_pixels_74.setValue(10)
        box_min_pixels_74.local_path = "integration.background.simple.min_pixels"
        box_min_pixels_74.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_pixels_74.addWidget(box_min_pixels_74)
        bg_box.addLayout(hbox_lay_min_pixels_74)

        label_75 = QLabel("        median")
        label_75.setPalette(palette_scope)
        label_75.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_75)

        label_76 = QLabel("        gmodel")
        label_76.setPalette(palette_scope)
        label_76.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_76)

        label_77 = QLabel("            robust")
        ...
        box_algorithm_78.local_path = "integration.background.gmodel.robust.algorithm"
        box_algorithm_78.tmp_lst=[]
        box_algorithm_78.tmp_lst.append("True")
        box_algorithm_78.tmp_lst.append("False")
        ...
        hbox_lay_tuning_constant_79 =  QHBoxLayout()
        label_tuning_constant_79 = QLabel("                tuning_constant")
        label_tuning_constant_79.setPalette(palette_object)
        label_tuning_constant_79.setFont(QFont("Monospace", 10))
        hbox_lay_tuning_constant_79.addWidget(label_tuning_constant_79)

        box_tuning_constant_79 = QDoubleSpinBox()
        box_tuning_constant_79.setValue(1.345)
        box_tuning_constant_79.local_path = "integration.background.gmodel.robust.tuning_constant"
        box_tuning_constant_79.valueChanged.connect(self.spnbox_changed)
        hbox_lay_tuning_constant_79.addWidget(box_tuning_constant_79)
        bg_box.addLayout(hbox_lay_tuning_constant_79)

        hbox_lay_min_pixels_80 =  QHBoxLayout()
        label_min_pixels_80 = QLabel("            min_pixels")
        label_min_pixels_80.setPalette(palette_object)
        label_min_pixels_80.setFont(QFont("Monospace", 10))
        hbox_lay_min_pixels_80.addWidget(label_min_pixels_80)

        box_min_pixels_80 = QSpinBox()
        box_min_pixels_80.setValue(10)
        box_min_pixels_80.local_path = "integration.background.gmodel.min_pixels"
        box_min_pixels_80.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_pixels_80.addWidget(box_min_pixels_80)
        bg_box.addLayout(hbox_lay_min_pixels_80)

        hbox_lay_model_81 =  QHBoxLayout()
        label_model_81 = QLabel("            model")
        label_model_81.setPalette(palette_object)
        label_model_81.setFont(QFont("Monospace", 10))
        hbox_lay_model_81.addWidget(label_model_81)

        box_model_81 = QLineEdit()
        box_model_81.local_path = "integration.background.gmodel.model"
        box_model_81.textChanged.connect(self.spnbox_changed)
        hbox_lay_model_81.addWidget(box_model_81)
        bg_box.addLayout(hbox_lay_model_81)
        ...
        label_83 = QLabel("            robust")
        label_83.setPalette(palette_scope)
        label_83.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_83)

        hbox_lay_tuning_constant_84 =  QHBoxLayout()
        label_tuning_constant_84 = QLabel("                tuning_constant")
        label_tuning_constant_84.setPalette(palette_object)
        label_tuning_constant_84.setFont(QFont("Monospace", 10))
        hbox_lay_tuning_constant_84.addWidget(label_tuning_constant_84)

        box_tuning_constant_84 = QDoubleSpinBox()
        box_tuning_constant_84.setValue(1.345)
        box_tuning_constant_84.local_path = "integration.background.glm.robust.tuning_constant"
        box_tuning_constant_84.valueChanged.connect(self.spnbox_changed)
        hbox_lay_tuning_constant_84.addWidget(box_tuning_constant_84)
        bg_box.addLayout(hbox_lay_tuning_constant_84)

        label_85 = QLabel("            model")
        label_85.setPalette(palette_scope)
        label_85.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_85)

        hbox_lay_algorithm_86 =  QHBoxLayout()
        label_algorithm_86 = QLabel("                algorithm")
        label_algorithm_86.setPalette(palette_object)
        label_algorithm_86.setFont(QFont("Monospace", 10))
        hbox_lay_algorithm_86.addWidget(label_algorithm_86)

        box_algorithm_86 = QComboBox()
        box_algorithm_86.local_path = "integration.background.glm.model.algorithm"
        box_algorithm_86.tmp_lst=[]
        box_algorithm_86.tmp_lst.append("constant2d")
        box_algorithm_86.tmp_lst.append("constant3d")
        box_algorithm_86.tmp_lst.append("loglinear2d")
        box_algorithm_86.tmp_lst.append("loglinear3d")
        for lst_itm in box_algorithm_86.tmp_lst:
            box_algorithm_86.addItem(lst_itm)
        box_algorithm_86.setCurrentIndex(1)
        box_algorithm_86.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_algorithm_86.addWidget(box_algorithm_86)
        bg_box.addLayout(hbox_lay_algorithm_86)

        hbox_lay_min_pixels_87 =  QHBoxLayout()
        label_min_pixels_87 = QLabel("            min_pixels")
        label_min_pixels_87.setPalette(palette_object)
        label_min_pixels_87.setFont(QFont("Monospace", 10))
        hbox_lay_min_pixels_87.addWidget(label_min_pixels_87)

        box_min_pixels_87 = QSpinBox()
        box_min_pixels_87.setValue(10)
        box_min_pixels_87.local_path = "integration.background.glm.min_pixels"
        box_min_pixels_87.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_pixels_87.addWidget(box_min_pixels_87)
        bg_box.addLayout(hbox_lay_min_pixels_87)

        label_88 = QLabel("        const_d")
        label_88.setPalette(palette_scope)
        label_88.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_88)

        label_89 = QLabel("    centroid")
        label_89.setPalette(palette_scope)
        label_89.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_89)

        hbox_lay_algorithm_90 =  QHBoxLayout()
        label_algorithm_90 = QLabel("        algorithm")
        label_algorithm_90.setPalette(palette_object)
        label_algorithm_90.setFont(QFont("Monospace", 10))
        hbox_lay_algorithm_90.addWidget(label_algorithm_90)

        box_algorithm_90 = QComboBox()
        box_algorithm_90.local_path = "integration.centroid.algorithm"
        box_algorithm_90.tmp_lst=[]
        box_algorithm_90.tmp_lst.append("simple")
        for lst_itm in box_algorithm_90.tmp_lst:
            box_algorithm_90.addItem(lst_itm)
        box_algorithm_90.setCurrentIndex(0)
        box_algorithm_90.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_algorithm_90.addWidget(box_algorithm_90)
        bg_box.addLayout(hbox_lay_algorithm_90)

        label_91 = QLabel("profile")
        ...
        box_algorithm_92.local_path = "profile.algorithm"
        box_algorithm_92.tmp_lst=[]
        box_algorithm_92.tmp_lst.append("gaussian_rs")
        for lst_itm in box_algorithm_92.tmp_lst:
            box_algorithm_92.addItem(lst_itm)
        box_algorithm_92.setCurrentIndex(0)
        ...
        label_93 = QLabel("    gaussian_rs")
        label_93.setPalette(palette_scope)
        label_93.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_93)

        hbox_lay_scan_varying_94 =  QHBoxLayout()
        label_scan_varying_94 = QLabel("        scan_varying")
        label_scan_varying_94.setPalette(palette_object)
        label_scan_varying_94.setFont(QFont("Monospace", 10))
        hbox_lay_scan_varying_94.addWidget(label_scan_varying_94)

        box_scan_varying_94 = QComboBox()
        box_scan_varying_94.local_path = "profile.gaussian_rs.scan_varying"
        box_scan_varying_94.tmp_lst=[]
        box_scan_varying_94.tmp_lst.append("True")
        box_scan_varying_94.tmp_lst.append("False")
        for lst_itm in box_scan_varying_94.tmp_lst:
            box_scan_varying_94.addItem(lst_itm)
        box_scan_varying_94.setCurrentIndex(1)
        box_scan_varying_94.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_scan_varying_94.addWidget(box_scan_varying_94)
        bg_box.addLayout(hbox_lay_scan_varying_94)

        label_95 = QLabel("        min_spots")
        label_95.setPalette(palette_scope)
        label_95.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_95)

        hbox_lay_overall_96 =  QHBoxLayout()
        label_overall_96 = QLabel("            overall")
        label_overall_96.setPalette(palette_object)
        label_overall_96.setFont(QFont("Monospace", 10))
        hbox_lay_overall_96.addWidget(label_overall_96)

        box_overall_96 = QSpinBox()
        box_overall_96.setValue(100)
        box_overall_96.local_path = "profile.gaussian_rs.min_spots.overall"
        box_overall_96.valueChanged.connect(self.spnbox_changed)
        hbox_lay_overall_96.addWidget(box_overall_96)
        bg_box.addLayout(hbox_lay_overall_96)

        hbox_lay_per_degree_97 =  QHBoxLayout()
        label_per_degree_97 = QLabel("            per_degree")
        label_per_degree_97.setPalette(palette_object)
        label_per_degree_97.setFont(QFont("Monospace", 10))
        hbox_lay_per_degree_97.addWidget(label_per_degree_97)

        box_per_degree_97 = QSpinBox()
        box_per_degree_97.setValue(50)
        box_per_degree_97.local_path = "profile.gaussian_rs.min_spots.per_degree"
        box_per_degree_97.valueChanged.connect(self.spnbox_changed)
        hbox_lay_per_degree_97.addWidget(box_per_degree_97)
        bg_box.addLayout(hbox_lay_per_degree_97)

        label_98 = QLabel("        parameters")
        label_98.setPalette(palette_scope)
        label_98.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_98)

        hbox_lay_sigma_b_99 =  QHBoxLayout()
        label_sigma_b_99 = QLabel("            sigma_b")
        label_sigma_b_99.setPalette(palette_object)
        label_sigma_b_99.setFont(QFont("Monospace", 10))
        hbox_lay_sigma_b_99.addWidget(label_sigma_b_99)

        box_sigma_b_99 = QDoubleSpinBox()
        box_sigma_b_99.local_path = "profile.gaussian_rs.parameters.sigma_b"
        box_sigma_b_99.valueChanged.connect(self.spnbox_changed)
        hbox_lay_sigma_b_99.addWidget(box_sigma_b_99)
        bg_box.addLayout(hbox_lay_sigma_b_99)

        hbox_lay_sigma_m_100 =  QHBoxLayout()
        label_sigma_m_100 = QLabel("            sigma_m")
        label_sigma_m_100.setPalette(palette_object)
        label_sigma_m_100.setFont(QFont("Monospace", 10))
        hbox_lay_sigma_m_100.addWidget(label_sigma_m_100)

        box_sigma_m_100 = QDoubleSpinBox()
        box_sigma_m_100.local_path = "profile.gaussian_rs.parameters.sigma_m"
        box_sigma_m_100.valueChanged.connect(self.spnbox_changed)
        hbox_lay_sigma_m_100.addWidget(box_sigma_m_100)
        bg_box.addLayout(hbox_lay_sigma_m_100)

        label_101 = QLabel("        filter")
        label_101.setPalette(palette_scope)
        label_101.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_101)

        hbox_lay_min_zeta_102 =  QHBoxLayout()
        label_min_zeta_102 = QLabel("            min_zeta")
        label_min_zeta_102.setPalette(palette_object)
        label_min_zeta_102.setFont(QFont("Monospace", 10))
        hbox_lay_min_zeta_102.addWidget(label_min_zeta_102)

        box_min_zeta_102 = QDoubleSpinBox()
        box_min_zeta_102.setValue(0.05)
        box_min_zeta_102.local_path = "profile.gaussian_rs.filter.min_zeta"
        box_min_zeta_102.valueChanged.connect(self.spnbox_changed)
        hbox_lay_min_zeta_102.addWidget(box_min_zeta_102)
        bg_box.addLayout(hbox_lay_min_zeta_102)

        label_103 = QLabel("        fitting")
        label_103.setPalette(palette_scope)
        label_103.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_103)

        hbox_lay_scan_step_104 =  QHBoxLayout()
        label_scan_step_104 = QLabel("            scan_step")
        label_scan_step_104.setPalette(palette_object)
        label_scan_step_104.setFont(QFont("Monospace", 10))
        hbox_lay_scan_step_104.addWidget(label_scan_step_104)

        box_scan_step_104 = QDoubleSpinBox()
        box_scan_step_104.setValue(5.0)
        box_scan_step_104.local_path = "profile.gaussian_rs.fitting.scan_step"
        box_scan_step_104.valueChanged.connect(self.spnbox_changed)
        hbox_lay_scan_step_104.addWidget(box_scan_step_104)
        bg_box.addLayout(hbox_lay_scan_step_104)

        hbox_lay_grid_size_105 =  QHBoxLayout()
        label_grid_size_105 = QLabel("            grid_size")
        label_grid_size_105.setPalette(palette_object)
        label_grid_size_105.setFont(QFont("Monospace", 10))
        hbox_lay_grid_size_105.addWidget(label_grid_size_105)

        box_grid_size_105 = QSpinBox()
        box_grid_size_105.setValue(5)
        box_grid_size_105.local_path = "profile.gaussian_rs.fitting.grid_size"
        box_grid_size_105.valueChanged.connect(self.spnbox_changed)
        hbox_lay_grid_size_105.addWidget(box_grid_size_105)
        bg_box.addLayout(hbox_lay_grid_size_105)

        hbox_lay_threshold_106 =  QHBoxLayout()
        label_threshold_106 = QLabel("            threshold")
        label_threshold_106.setPalette(palette_object)
        label_threshold_106.setFont(QFont("Monospace", 10))
        hbox_lay_threshold_106.addWidget(label_threshold_106)

        box_threshold_106 = QDoubleSpinBox()
        box_threshold_106.setValue(0.02)
        box_threshold_106.local_path = "profile.gaussian_rs.fitting.threshold"
        box_threshold_106.valueChanged.connect(self.spnbox_changed)
        hbox_lay_threshold_106.addWidget(box_threshold_106)
        bg_box.addLayout(hbox_lay_threshold_106)

        hbox_lay_grid_method_107 =  QHBoxLayout()
        label_grid_method_107 = QLabel("            grid_method")
        label_grid_method_107.setPalette(palette_object)
        label_grid_method_107.setFont(QFont("Monospace", 10))
        hbox_lay_grid_method_107.addWidget(label_grid_method_107)

        box_grid_method_107 = QComboBox()
        box_grid_method_107.local_path = "profile.gaussian_rs.fitting.grid_method"
        box_grid_method_107.tmp_lst=[]
        box_grid_method_107.tmp_lst.append("single")
        box_grid_method_107.tmp_lst.append("regular_grid")
        box_grid_method_107.tmp_lst.append("circular_grid")
        for lst_itm in box_grid_method_107.tmp_lst:
            box_grid_method_107.addItem(lst_itm)
        box_grid_method_107.setCurrentIndex(1)
        box_grid_method_107.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_grid_method_107.addWidget(box_grid_method_107)
        bg_box.addLayout(hbox_lay_grid_method_107)

        hbox_lay_fit_method_108 =  QHBoxLayout()
        label_fit_method_108 = QLabel("            fit_method")
        label_fit_method_108.setPalette(palette_object)
        label_fit_method_108.setFont(QFont("Monospace", 10))
        hbox_lay_fit_method_108.addWidget(label_fit_method_108)

        box_fit_method_108 = QComboBox()
        box_fit_method_108.local_path = "profile.gaussian_rs.fitting.fit_method"
        box_fit_method_108.tmp_lst=[]
        box_fit_method_108.tmp_lst.append("reciprocal_space")
        box_fit_method_108.tmp_lst.append("detector_space")
        for lst_itm in box_fit_method_108.tmp_lst:
            box_fit_method_108.addItem(lst_itm)
        box_fit_method_108.setCurrentIndex(0)
        box_fit_method_108.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_fit_method_108.addWidget(box_fit_method_108)
        bg_box.addLayout(hbox_lay_fit_method_108)

        label_109 = QLabel("prediction")
        label_109.setPalette(palette_scope)
        label_109.setFont(QFont("Monospace", 10, QFont.Bold))
        bg_box.addWidget(label_109)

        hbox_lay_d_min_110 =  QHBoxLayout()
        label_d_min_110 = QLabel("    d_min")
        label_d_min_110.setPalette(palette_object)
        label_d_min_110.setFont(QFont("Monospace", 10))
        hbox_lay_d_min_110.addWidget(label_d_min_110)

        box_d_min_110 = QDoubleSpinBox()
        box_d_min_110.local_path = "prediction.d_min"
        box_d_min_110.valueChanged.connect(self.spnbox_changed)
        hbox_lay_d_min_110.addWidget(box_d_min_110)
        bg_box.addLayout(hbox_lay_d_min_110)

        hbox_lay_d_max_111 =  QHBoxLayout()
        label_d_max_111 = QLabel("    d_max")
        label_d_max_111.setPalette(palette_object)
        label_d_max_111.setFont(QFont("Monospace", 10))
        hbox_lay_d_max_111.addWidget(label_d_max_111)

        box_d_max_111 = QDoubleSpinBox()
        box_d_max_111.local_path = "prediction.d_max"
        box_d_max_111.valueChanged.connect(self.spnbox_changed)
        hbox_lay_d_max_111.addWidget(box_d_max_111)
        bg_box.addLayout(hbox_lay_d_max_111)

        hbox_lay_margin_112 =  QHBoxLayout()
        label_margin_112 = QLabel("    margin")
        label_margin_112.setPalette(palette_object)
        label_margin_112.setFont(QFont("Monospace", 10))
        hbox_lay_margin_112.addWidget(label_margin_112)

        box_margin_112 = QSpinBox()
        box_margin_112.setValue(1)
        box_margin_112.local_path = "prediction.margin"
        box_margin_112.valueChanged.connect(self.spnbox_changed)
        hbox_lay_margin_112.addWidget(box_margin_112)
        bg_box.addLayout(hbox_lay_margin_112)

        hbox_lay_force_static_113 =  QHBoxLayout()
        label_force_static_113 = QLabel("    force_static")
        label_force_static_113.setPalette(palette_object)
        label_force_static_113.setFont(QFont("Monospace", 10))
        hbox_lay_force_static_113.addWidget(label_force_static_113)

        box_force_static_113 = QComboBox()
        box_force_static_113.local_path = "prediction.force_static"
        box_force_static_113.tmp_lst=[]
        box_force_static_113.tmp_lst.append("True")
        box_force_static_113.tmp_lst.append("False")
        for lst_itm in box_force_static_113.tmp_lst:
            box_force_static_113.addItem(lst_itm)
        box_force_static_113.setCurrentIndex(1)
        box_force_static_113.currentIndexChanged.connect(self.combobox_changed)
        hbox_lay_force_static_113.addWidget(box_force_static_113)
        bg_box.addLayout(hbox_lay_force_static_113)
