...
class ChangeParameter(QWidget):
    ...
    def __init__(self):
        ...
        m_vbox.addWidget(self.ChangeWidgetButton)
...
class ImportPage(QWidget):
    ...
    def __init__(self):
        ...
        #template_vbox.addWidget(self.par_widg)

        ##########################

        self.my_stackedWidget =  QStackedWidget()
        self.overide_button = QPushButton("Overide Parameter")
        self.my_stackedWidget.addWidget(self.overide_button)
        ...
        self.overide_button.clicked.connect(self.set_par_widg)
    ...
    def set_overide_button(self):
        ...
        self.my_stackedWidget.setCurrentWidget(self.overide_button)
